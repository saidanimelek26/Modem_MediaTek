...
#ifndef  _CRFCALCWCTRL_MT6177L_H_
#define  _CRFCALCWCTRL_MT6177L_H_
...
#define CL1D_TX_PRE_CAPTUN_SEQ_TABLE_LENGTH             (2)
#define CL1D_TX_PHASE_STEP_CAL_TABLE_LENGTH             (2)

//RX DC algorithm input
#define C1LD_RFC_IS_DC_ALGO_DIG_DC_ONLY_IN_HPM           KAL_FALSE
#define C1LD_RFC_IS_DC_ALGO_DIG_DC_ONLY_IN_LPM           KAL_FALSE
...
const MMPOC_RF_TX_CW_DATA_T* CL1D_Get_TX_CW_Table_By_Band(const MMRFC_XL1_BAND_NUM_E band);
...
void CL1D_RFC_SET_RF_CW_TX_LPF(MMRFC_XL1_BAND_NUM_E band, MMRFC_TX_RAT_CBW_CFG_E tx_cbw, kal_uint32 lpf_rsel, kal_bool is_abb_4dB, kal_bool is_tdd_band, MML1_RF_BSIMM_PORT_T port_sel);
void CL1D_RFC_SET_RF_CW_TX_RCCAL1(MMRFC_XL1_BAND_NUM_E band, kal_uint32 rccal_csel, MML1_RF_BSIMM_PORT_T port_sel);
...
void CL1D_RFC_SET_RF_CAPCODE_COMBINE(kal_uint32 PGA_AB, kal_uint32 CAP_OPT, kal_uint32 CAP_CURRENT, kal_uint32 Tx_cap_port_sel );
...
void CL1D_RFC_SET_TX_LBPK(kal_uint32 LBPK_idx, MMRFC_XL1_BAND_NUM_E curr_band, kal_uint32 TX_Gain_idx, kal_uint32 TX_LBPK_port, kal_bool is_PA_ON);
...
void CL1D_RFC_LO_DET_Cal_Config(MMRFC_XL1_BAND_NUM_E poc_band, MML1_RF_BSIMM_PORT_T port_sel);
