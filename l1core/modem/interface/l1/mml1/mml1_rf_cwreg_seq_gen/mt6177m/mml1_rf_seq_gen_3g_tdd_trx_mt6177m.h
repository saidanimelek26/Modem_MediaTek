 ...
 * Filename:
 * ---------
 *   mml1_rf_seq_gen_3g_tdd_trx_mt6177m.h
 *
 * Project:
 * --------
 *   MT6293
...
#ifndef __MMRFSEQGEN_3G_TDD_TRX_MT6177M_H__
#define __MMRFSEQGEN_3G_TDD_TRX_MT6177M_H__
...
#define SEQ_TDSCDMA_3G_TDD_RX1_TRX_SL2W_COUNT (36)

#define SEQ_TDSCDMA_3G_TDD_RX1_TX_W2B_COUNT (2)

#define SEQ_TDSCDMA_3G_TDD_RX1_RX_W2B_COUNT (4)

#define SEQ_TDSCDMA_3G_TDD_RX1_TRX_B2SL_COUNT (1)

#define SEQ_TDSCDMA_3G_TDD_RX1_RX_PF0_COUNT (2)
...
}SEQ_TDSCDMA_3G_TDD_RX1_TX_W2B_INFO_T;
...
}SEQ_TDSCDMA_3G_TDD_RX1_RX_W2B_INFO_T;


typedef struct
{
   CW1_INFO_T cw1_info;
}SEQ_TDSCDMA_3G_TDD_RX1_TRX_B2SL_INFO_T;
...
typedef struct
{
   CW320_INFO_T cw320_info;
   CW321_INFO_T cw321_info;
}SEQ_TDSCDMA_3G_TDD_RX1_RX_PF0_INFO_T;
...
void MMRF_SEQ_TDSCDMA_3G_TDD_RX1_TX_W2B ( SEQ_TDSCDMA_3G_TDD_RX1_TX_W2B_INFO_T *seq_tdscdma_3g_tdd_rx1_tx_w2b_info, kal_uint32 *bsiData);
void MMRF_SEQ_TDSCDMA_3G_TDD_RX1_RX_W2B ( SEQ_TDSCDMA_3G_TDD_RX1_RX_W2B_INFO_T *seq_tdscdma_3g_tdd_rx1_rx_w2b_info, kal_uint32 *bsiData);
void MMRF_SEQ_TDSCDMA_3G_TDD_RX1_TRX_B2SL ( SEQ_TDSCDMA_3G_TDD_RX1_TRX_B2SL_INFO_T *seq_tdscdma_3g_tdd_rx1_trx_b2sl_info, kal_uint32 *bsiData);
void MMRF_SEQ_TDSCDMA_3G_TDD_RX1_RX_PF0 ( SEQ_TDSCDMA_3G_TDD_RX1_RX_PF0_INFO_T *seq_tdscdma_3g_tdd_rx1_rx_pf0_info, kal_uint32 *bsiData);
...
#endif /*__MMRFSEQGEN_3G_TDD_TRX_MT6177M_H__*/
