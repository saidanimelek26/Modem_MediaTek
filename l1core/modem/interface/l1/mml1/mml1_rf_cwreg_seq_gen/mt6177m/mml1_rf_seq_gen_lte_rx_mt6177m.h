...
#ifndef __MMRFSEQGEN_LTE_RX_MT6173_H__
#define __MMRFSEQGEN_LTE_RX_MT6173_H__
...
#define SEQ_LTE_FDD_RX1_SL2W_COUNT (16)

#define SEQ_LTE_FDD_RX1_W2B_COUNT (3)

#define SEQ_LTE_FDD_RX1_DCOC_CAL_COUNT (18)

#define SEQ_LTE_FDD_RX1_IRR_CAL_COUNT (31)

#define SEQ_LTE_FDD_RX1_IIP2_CAL_COUNT (22)

#define SEQ_LTE_FDD_RX1_PMODE_CHANGE_COUNT (10)

#define SEQ_LTE_FDD_RX1_GAIN_CHANGE_COUNT (6)

#define SEQ_LTE_FDD_RX1_BW_CHANGE_COUNT (3)

#define SEQ_LTE_FDD_RX1_IIP2C_CODE_COUNT (1)

#define SEQ_LTE_FDD_RX1_POFF_COUNT (2)

#define SEQ_LTE_FDD_RX1_SYNTH_ADJ_COUNT (1)

#define SEQ_LTE_TDD_RX1_B2SL_COUNT (1)

#define SEQ_LTE_TDD_RX1_SL2W_COUNT (16)

#define SEQ_LTE_TDD_RX1_W2B_COUNT (3)

#define SEQ_LTE_TDD_RX1_DCOC_CAL_COUNT (18)

#define SEQ_LTE_TDD_RX1_IRR_CAL_COUNT (31)

#define SEQ_LTE_TDD_RX1_IIP2_CAL_COUNT (22)

#define SEQ_LTE_TDD_RX1_PMODE_CHANGE_COUNT (10)

#define SEQ_LTE_TDD_RX1_GAIN_CHANGE_COUNT (6)

#define SEQ_LTE_TDD_RX1_BW_CHANGE_COUNT (3)

#define SEQ_LTE_TDD_RX1_POFF_COUNT (2)
...
typedef struct
{
   ...
   CW500_INFO_T cw500_info;
   CW501_INFO_T cw501_info;
}SEQ_LTE_FDD_RX1_DCOC_CAL_INFO_T;
...
}SEQ_LTE_FDD_RX1_IRR_CAL_INFO_T;
...
typedef struct
{
   ...
   CW495_INFO_T cw495_info;
   CW500_INFO_T cw500_info;
}SEQ_LTE_FDD_RX1_IIP2_CAL_INFO_T;
...
typedef struct
{
   ...
   CW413_INFO_T cw413_info;
   CW414_INFO_T cw414_info;
}SEQ_LTE_FDD_RX1_PMODE_CHANGE_INFO_T;
...
typedef struct
{
   ...
   CW338_INFO_T cw338_info;
   CW339_INFO_T cw339_info;
}SEQ_LTE_FDD_RX1_GAIN_CHANGE_INFO_T;
...
typedef struct
{
   ...
   //CW353_INFO_T cw353_info;
   //CW356_INFO_T cw356_info;
}SEQ_LTE_FDD_RX1_BW_CHANGE_INFO_T;


typedef struct
{
   CW473_INFO_T cw473_info;
}SEQ_LTE_FDD_RX1_IIP2C_CODE_INFO_T;
...
typedef struct
{
   ...
   CW500_INFO_T cw500_info;
   CW501_INFO_T cw501_info;
}SEQ_LTE_TDD_RX1_DCOC_CAL_INFO_T;
...
typedef struct
{
   ...
   CW52_INFO_T cw52_info;
   CW53_INFO_T cw53_info;
}SEQ_LTE_TDD_RX1_IRR_CAL_INFO_T;
...
typedef struct
{
   ...
   CW495_INFO_T cw495_info;
   CW500_INFO_T cw500_info;
}SEQ_LTE_TDD_RX1_IIP2_CAL_INFO_T;
...
typedef struct
{
   ...
   CW413_INFO_T cw413_info;
   CW414_INFO_T cw414_info;
}SEQ_LTE_TDD_RX1_PMODE_CHANGE_INFO_T;
...
typedef struct
{
   ...
   CW338_INFO_T cw338_info;
   CW339_INFO_T cw339_info;
}SEQ_LTE_TDD_RX1_GAIN_CHANGE_INFO_T;
...
typedef struct
{
   ...
   //CW353_INFO_T cw353_info;
   //CW356_INFO_T cw356_info;
}SEQ_LTE_TDD_RX1_BW_CHANGE_INFO_T;
...
void MMRF_SEQ_LTE_TDD_RX1_B2SL ( SEQ_LTE_TDD_RX1_B2SL_INFO_T *seq_lte_tdd_rx1_b2sl_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_SL2W ( SEQ_LTE_TDD_RX1_SL2W_INFO_T *seq_lte_tdd_rx1_sl2w_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_W2B ( SEQ_LTE_TDD_RX1_W2B_INFO_T *seq_lte_tdd_rx1_w2b_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_DCOC_CAL ( SEQ_LTE_TDD_RX1_DCOC_CAL_INFO_T *seq_lte_tdd_rx1_dcoc_cal_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_IRR_CAL ( SEQ_LTE_TDD_RX1_IRR_CAL_INFO_T *seq_lte_tdd_rx1_irr_cal_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_IIP2_CAL ( SEQ_LTE_TDD_RX1_IIP2_CAL_INFO_T *seq_lte_tdd_rx1_iip2_cal_info, kal_uint32 *bsiData);
...
void MMRF_SEQ_LTE_TDD_RX1_GAIN_CHANGE ( SEQ_LTE_TDD_RX1_GAIN_CHANGE_INFO_T *seq_lte_tdd_rx1_gain_change_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_BW_CHANGE ( SEQ_LTE_TDD_RX1_BW_CHANGE_INFO_T *seq_lte_tdd_rx1_bw_change_info, kal_uint32 *bsiData);
void MMRF_SEQ_LTE_TDD_RX1_POFF ( SEQ_LTE_TDD_RX1_POFF_INFO_T *seq_lte_tdd_rx1_poff_info, kal_uint32 *bsiData);

#endif /*__MMRFSEQGEN_LTE_RX_MT6173_H__*/