...
include make/common/rel/REL_COMP_COMMON.mak
...
REL_MTK_COMP_CR_COMMON += ddm
REL_MTK_COMP_CR_COMMON += dhcp
REL_MTK_COMP_CR_COMMON += dhl_sub
REL_MTK_COMP_CR_COMMON += drv_hif
...
REL_MTK_COMP_CR_COMMON += esim_evrf_bridge
REL_MTK_COMP_CR_COMMON += esim_hl_evrf_bridge
REL_MTK_COMP_CR_COMMON += gbst_bridge
REL_MTK_COMP_CR_COMMON += gsim_hw
REL_MTK_COMP_CR_COMMON += gsim_nw
REL_MTK_COMP_CR_COMMON += usim_uvrf_hl_bridge
REL_MTK_COMP_CR_COMMON += xsim_framework
REL_MTK_COMP_CR_COMMON += xsim_gw
REL_MTK_COMP_CR_COMMON += xsim_platform
REL_MTK_COMP_CR_COMMON += c2k_vmmi_bridge
REL_MTK_COMP_CR_COMMON += c2k_xsim_gw
REL_MTK_COMP_CR_COMMON += c2k_xsim_platform
REL_MTK_COMP_CR_COMMON += c2ksim_hw
REL_MTK_COMP_CR_COMMON += nal
REL_MTK_COMP_CR_COMMON += atp_protected
REL_MTK_COMP_CR_COMMON += iwlan
REL_MTK_COMP_CR_COMMON += wo
REL_MTK_COMP_CR_COMMON += simmngr