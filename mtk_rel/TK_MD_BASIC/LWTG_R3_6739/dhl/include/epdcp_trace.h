...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_UNDO_UDC_SDUS(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_UNDO_UDC_SDUS(v1, v2, v3, v4)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_W_CMP_REQ(v1, v2, v3, v4, v5) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_W_CMP_REQ(v1, v2, v3, v4, v5)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_ACTVING_UPDT_NEW(v1, v2, v3) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_ACTVING_UPDT_NEW(v1, v2, v3)
#endif
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_CUR_RST_ST(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_CUR_RST_ST(v1, v2)
#endif
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_SET_RST_ON_CMP_REQ(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_SET_RST_ON_CMP_REQ(v1, v2, v3, v4)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_RCVD_RST_IN_CMP_RSLT(v1, v2, v3, v4, v5, v6) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_RCVD_RST_IN_CMP_RSLT(v1, v2, v3, v4, v5, v6)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_CLR_RST_ST() do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_START_FILL_L2();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L2(0x3514,0x3514);\
			TRC_END_FILL_L2();\
			TRC_END_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
#else
	#define EPDCP_UL_LOG_UDC_CLR_RST_ST()
#endif
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_PUT_SDUS_IN_UDC_Q(v1, v2, v3, v4, v5, v6, v7) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_PUT_SDUS_IN_UDC_Q(v1, v2, v3, v4, v5, v6, v7)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_CMP_REQ_FULL(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_CMP_REQ_FULL(v1, v2, v3, v4)
#endif
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EPDCP_UL_LOG_UDC_PREDO_UDC_SDUS(v1, v2, v3, v4, v5, v6) do {\
		{\
			TRC_START_FILTER_CHECK_L2(EPDCP_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L2(cgen_local_v2,v2);\
...
#else
	#define EPDCP_UL_LOG_UDC_PREDO_UDC_SDUS(v1, v2, v3, v4, v5, v6)
#endif
...
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_UNDO_UDC_SDUS()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_W_CMP_REQ()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_ACTVING_UPDT_NEW()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_CUR_ACT_ST()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_CUR_RST_ST()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_SET_RST_ST()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_SET_RST_ON_CMP_REQ()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_RCVD_RST_IN_CMP_RSLT()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_CLR_RST_ST()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_INVALID_RST_SDU_IDX()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
#define ChkL1MsgFltr_EPDCP_UL_LOG_PUT_SDUS_IN_UDC_Q()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
...
#define ChkL1MsgFltr_EPDCP_UL_LOG_UDC_PREDO_UDC_SDUS()	ChkL1ClsFltr_EPDCP_EPDCP_UL_INFO()
