...
#define PHS_ISR_MSG_STRING(v1)  (unsigned char)(v1+157)
#define PHS_TASK_TX_MSG_STRING(v1)  (unsigned char)(v1+182)
#define PHS_RX_STATE_STRING(v1)  (unsigned char)(v1+184)
#define PHS_L1D_HRT_RPT_STRING(v1)  (unsigned char)(v1+189)
#define PHS_MIB_RLT_STRING(v1)  (unsigned char)(v1+195)
#define PHS_PRESYNC_TYPE_STRING(v1)  (unsigned char)(v1+198)
#define PHS_NBR_GET_TYPE_STRING(v1)  (unsigned char)(v1+203)
#define PHS_RSVAS_ST_STRING(v1)  (unsigned char)(v1+205)
#define PHS_SCHDL_FAIL_CAUSE(v1)  (unsigned char)(v1+208)
#define PHS_ISR_CTRL_REQ_SRC(v1)  (unsigned char)(v1+232)
#define PHS_SIM_IDX_STRING_1(v1)  (unsigned char)(v1+242)
