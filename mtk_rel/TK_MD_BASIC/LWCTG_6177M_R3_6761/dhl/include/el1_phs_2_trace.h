...
#define PHS_CNF_WAIT_STRING(v1)  (unsigned char)(v1+108)
#define PHS_L1D_HP_RPT_STRING(v1)  (unsigned char)(v1+134)
#define PHS_L1D_LP_RPT_STRING(v1)  (unsigned char)(v1+143)
#define PHS_TX2RX_MSG(v1)  (unsigned char)(v1+148)
#define PHS_SCELL_STATUS(v1)  (unsigned char)(v1+157)
#define PHS_SCALL_ACTV_ACTION(v1)  (unsigned char)(v1+166)
#define PHS_EVT_ACTION_CONFIG(v1)  (unsigned char)(v1+176)
#define PHS_ISR_CMD_STRING(v1)  (unsigned char)(v1+179)
#define PHS_SIM_IDX_STRING_2(v1)  (unsigned char)(v1+213)
#define PHS_TAS_STATUS_STRING(v1)  (unsigned char)(v1+217)
#define PHS_INTER_SIM_CONFLICT_STRING(v1)  (unsigned char)(v1+224)
#define PHS_PARAM_TYPE_STRING(v1)  (unsigned char)(v1+229)
