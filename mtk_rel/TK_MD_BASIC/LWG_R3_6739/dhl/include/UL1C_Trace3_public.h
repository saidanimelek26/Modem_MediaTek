...
#include "L1Trc.h"
	...
	#define UL1T_TRC_RSSI_SNIFFER1(v1, v2) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0094,0x0094);\
	...
	#define UL1I_TRC_RSSI_SNIFFER2(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0194,0x0194);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
	...
	#define UL1T_TRC_RSSI_SNIFFER3(v1, v2, v3) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0294,0x0294);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
	...
	#define UL1T_TRC_TGPS_Act(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0394,0x0394);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v2,v2);\
	...
	#define UL1I_TRC_TGPS_Frame(v1, v2, v3, v4, v5, v6) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0494,0x0494);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
	...
	#define UL1I_TRC_TGPS_Status(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0594,0x0594);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_8_LAST_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_END_FILL_L1();\
