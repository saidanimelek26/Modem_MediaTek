...
const LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_ANTRX_EVENT_Set0[] = 
{
...
const LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_ANTRX_DATA_Set0[] = 
{
...
const LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_ANTTX_EVENT_Set0[] = 
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
...
const LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_ANTTX_DATA_Set0[] = 
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   },} },
};
...
kal_uint32 LTE_MIPI_ANTRX_EVENT_SIZE_TABLE_Set0[] =
{
   ...
   sizeof(LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR21,           Set0)),
   sizeof(LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR22,           Set0)),
   sizeof(LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR23,           Set0)),
   sizeof(LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR24,           Set0)),
   sizeof(LTE_MIPI_ANT_EVENT_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0)),
   LTE_MIPI_NULL,
};


const LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_ANTRX_EVENT_TABLE_Set0[] =
{
   ...
   LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR21,           Set0),
   LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR22,           Set0),
   LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR23,           Set0),
   LTE_MIPI_ANTRX_EVENT(     BAND_INDICATOR24,           Set0),
   LTE_MIPI_ANT_EVENT_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0),
   LTE_MIPI_NULL,
};


kal_uint32  LTE_MIPI_ANTRX_DATA_SIZE_TABLE_Set0[] =
{
   ...
   sizeof(LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR21,           Set0)),
   sizeof(LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR22,           Set0)),
   sizeof(LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR23,           Set0)),
   sizeof(LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR24,           Set0)),
   sizeof(LTE_MIPI_ANT_DATA_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0)),
   LTE_MIPI_NULL,
};


const LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_ANTRX_DATA_TABLE_Set0[] =
{
   ...
   LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR21,           Set0),
   LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR22,           Set0),
   LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR23,           Set0),
   LTE_MIPI_ANTRX_DATA(     BAND_INDICATOR24,           Set0),
   LTE_MIPI_ANT_DATA_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0),
   LTE_MIPI_NULL,
};


kal_uint32 LTE_MIPI_ANTTX_EVENT_SIZE_TABLE_Set0[] =
{
   ...
   sizeof(LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR21,           Set0)),
   sizeof(LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR22,           Set0)),
   sizeof(LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR23,           Set0)),
   sizeof(LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR24,           Set0)),
   sizeof(LTE_MIPI_ANT_EVENT_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0)),
   LTE_MIPI_NULL,
};


const LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_ANTTX_EVENT_TABLE_Set0[] =
{
   ...
   LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR21,           Set0),
   LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR22,           Set0),
   LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR23,           Set0),
   LTE_MIPI_ANTTX_EVENT(     BAND_INDICATOR24,           Set0),
   LTE_MIPI_ANT_EVENT_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0),
   LTE_MIPI_NULL,
};


kal_uint32  LTE_MIPI_ANTTX_DATA_SIZE_TABLE_Set0[] =
{
   ...
   sizeof(LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR21,           Set0)),
   sizeof(LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR22,           Set0)),
   sizeof(LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR23,           Set0)),
   sizeof(LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR24,           Set0)),
   sizeof(LTE_MIPI_ANT_DATA_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0)),
   LTE_MIPI_NULL,
};


const LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_ANTTX_DATA_TABLE_Set0[] =
{
   ...
   LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR21,           Set0),
   LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR22,           Set0),
   LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR23,           Set0),
   LTE_MIPI_ANTTX_DATA(     BAND_INDICATOR24,           Set0),
   LTE_MIPI_ANT_DATA_ROUTE(MIPI_ANT_ROUTE_IND25,        Set0),
   LTE_MIPI_NULL,
};
