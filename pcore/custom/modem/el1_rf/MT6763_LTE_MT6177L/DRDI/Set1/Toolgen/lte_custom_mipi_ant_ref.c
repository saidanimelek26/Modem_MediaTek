...
{
   sizeof(LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
...
{
   LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_EVENT(  BAND_INDICATOR_NONE,           Set1),
...
{
   sizeof(LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1)),
...
{
   LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTRX_DATA(  BAND_INDICATOR_NONE,           Set1),
...
{
   sizeof(LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1)),
...
{
   LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_EVENT(  BAND_INDICATOR_NONE,           Set1),
...
{
   sizeof(LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1)),
   sizeof(LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1)),
...
{
   LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1),
   LTE_MIPI_ANTTX_DATA(  BAND_INDICATOR_NONE,           Set1),
