...
kal_uint32  LTE_MIPI_DPD_PA_TPC_SECTION_DATA_SIZE_Set1[LTE_MAX_SUPPORT_TX_FE_ROUTE_NUM] =
{
   ...
   sizeof(LTE_MIPI_DPD_PA_SECTION_DATA_ROUTE(MIPI_TX_ROUTE_IND25, Set1)),
   sizeof(LTE_MIPI_DPD_PA_SECTION_DATA_ROUTE(MIPI_TX_ROUTE_IND26, Set1)),
   LTE_MIPI_NULL,
};
...
LTE_MIPI_TPC_SECTION_TABLE_DEFAULT  LTE_MIPI_DPD_PA_TPC_SECTION_DATA_Set1[LTE_MAX_SUPPORT_TX_FE_ROUTE_NUM] =
{
   ...
   {LTE_MIPI_DPD_PA_SECTION_DATA_ROUTE(MIPI_TX_ROUTE_IND25, Set1), LTE_MIPI_DPD_PA_SECTION_DATA_ROUTE(MIPI_TX_ROUTE_IND25, Set1), NO_CCA_SUPPORT},
   {LTE_MIPI_DPD_PA_SECTION_DATA_ROUTE(MIPI_TX_ROUTE_IND26, Set1), LTE_MIPI_DPD_PA_SECTION_DATA_ROUTE(MIPI_TX_ROUTE_IND26, Set1), NO_CCA_SUPPORT},
