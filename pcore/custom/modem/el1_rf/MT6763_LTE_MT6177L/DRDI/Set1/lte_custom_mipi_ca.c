...
const LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Route25_MIPI_RX_DATA_Set1[] =
{
   ...
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ { 19300 /*100 kHz*/ ,0x05 ,0x05 }, { 19450 /*100 kHz*/ ,0x05 ,0x05 }, { 19600 /*100 kHz*/ ,0x05 ,0x05 }, { 19750 /*100 kHz*/ ,0x05 ,0x05 }, { 19900 /*100 kHz*/ ,0x05 ,0x05 },} },
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ASM1_Set1   ,{ { 19300 /*100 kHz*/ ,0x00 ,0x02 }, { 19450 /*100 kHz*/ ,0x00 ,0x02 }, { 19600 /*100 kHz*/ ,0x00 ,0x02 }, { 19750 /*100 kHz*/ ,0x00 ,0x02 }, { 19900 /*100 kHz*/ ,0x00 ,0x02 },} },
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ { 19300 /*100 kHz*/ ,0x05 ,0x00 }, { 19450 /*100 kHz*/ ,0x05 ,0x00 }, { 19600 /*100 kHz*/ ,0x05 ,0x00 }, { 19750 /*100 kHz*/ ,0x05 ,0x00 }, { 19900 /*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ASM1_Set1   ,{ { 19300 /*100 kHz*/ ,0x00 ,0x00 }, { 19450 /*100 kHz*/ ,0x00 ,0x00 }, { 19600 /*100 kHz*/ ,0x00 ,0x00 }, { 19750 /*100 kHz*/ ,0x00 ,0x00 }, { 19900 /*100 kHz*/ ,0x00 ,0x00 },} },
...
{
   //No.      elm type     , port_sel          , data_seq      , USID                        ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ {  19300/*100 kHz*/ ,0x05 ,0x05 }, {  19463/*100 kHz*/ ,0x05 ,0x05 }, {  19625/*100 kHz*/ ,0x05 ,0x05 }, {  19788/*100 kHz*/ ,0x05 ,0x05 }, {  19950/*100 kHz*/ ,0x05 ,0x05 },} },
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ASM1_Set1   ,{ {  19300/*100 kHz*/ ,0x00 ,0x02 }, {  19463/*100 kHz*/ ,0x00 ,0x02 }, {  19625/*100 kHz*/ ,0x00 ,0x02 }, {  19788/*100 kHz*/ ,0x00 ,0x02 }, {  19950/*100 kHz*/ ,0x00 ,0x02 },} },
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ {  19300/*100 kHz*/ ,0x05 ,0x00 }, {  19463/*100 kHz*/ ,0x05 ,0x00 }, {  19625/*100 kHz*/ ,0x05 ,0x00 }, {  19788/*100 kHz*/ ,0x05 ,0x00 }, {  19950/*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ASM1_Set1   ,{ {  19300/*100 kHz*/ ,0x00 ,0x00 }, {  19463/*100 kHz*/ ,0x00 ,0x00 }, {  19625/*100 kHz*/ ,0x00 ,0x00 }, {  19788/*100 kHz*/ ,0x00 ,0x00 }, {  19950/*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 4  */ LTE_MIPI_NULL, 0                 , 0             , 0                           ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID                        ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ { 18500 /*100 kHz*/ ,0x00 , 0x7C }, { 18650 /*100 kHz*/ ,0x00 , 0x7C }, { 18800 /*100 kHz*/ ,0x00 , 0x7C }, { 18950 /*100 kHz*/ ,0x00 , 0x7C }, { 19100 /*100 kHz*/ ,0x00 , 0x7C },} }, // PA enable
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ { 18500 /*100 kHz*/ ,0x01 , 0x00 }, { 18650 /*100 kHz*/ ,0x01 , 0x00 }, { 18800 /*100 kHz*/ ,0x01 , 0x00 }, { 18950 /*100 kHz*/ ,0x01 , 0x00 }, { 19100 /*100 kHz*/ ,0x01 , 0x00 },} }, // PA bias                               
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ { 18500 /*100 kHz*/ ,0x03 , 0x00 }, { 18650 /*100 kHz*/ ,0x03 , 0x00 }, { 18800 /*100 kHz*/ ,0x03 , 0x00 }, { 18950 /*100 kHz*/ ,0x03 , 0x00 }, { 19100 /*100 kHz*/ ,0x03 , 0x00 },} }, // PA bias                               
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ { 18500 /*100 kHz*/ ,0x04 , 0x10 }, { 18650 /*100 kHz*/ ,0x04 , 0x10 }, { 18800 /*100 kHz*/ ,0x04 , 0x10 }, { 18950 /*100 kHz*/ ,0x04 , 0x10 }, { 19100 /*100 kHz*/ ,0x04 , 0x10 },} }, // ASM coupler on (at Tx off, PA type)                   
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ { 18500 /*100 kHz*/ ,0x00 , 0x00 }, { 18650 /*100 kHz*/ ,0x00 , 0x00 }, { 18800 /*100 kHz*/ ,0x00 , 0x00 }, { 18950 /*100 kHz*/ ,0x00 , 0x00 }, { 19100 /*100 kHz*/ ,0x00 , 0x00 },} }, // PA disable                            
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ { 18500 /*100 kHz*/ ,0x04 , 0x00 }, { 18650 /*100 kHz*/ ,0x04 , 0x00 }, { 18800 /*100 kHz*/ ,0x04 , 0x00 }, { 18950 /*100 kHz*/ ,0x04 , 0x00 }, { 19100 /*100 kHz*/ ,0x04 , 0x00 },} }, // ASM coupler disable                   
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ { 18500 /*100 kHz*/ ,0x05 , 0x05 }, { 18650 /*100 kHz*/ ,0x05 , 0x05 }, { 18800 /*100 kHz*/ ,0x05 , 0x05 }, { 18950 /*100 kHz*/ ,0x05 , 0x05 }, { 19100 /*100 kHz*/ ,0x05 , 0x05 },} }, // ASM TRX on                            
   //{ /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ { 18500 /*100 kHz*/ ,0x03 , 0x00 }, { 18650 /*100 kHz*/ ,0x03 , 0x00 }, { 18800 /*100 kHz*/ ,0x03 , 0x00 }, { 18950 /*100 kHz*/ ,0x03 , 0x00 }, { 19100 /*100 kHz*/ ,0x03 , 0x00 },} }, // ASM TRX off (at win off, valid for 92)
...
const LTE_MIPI_EVENT_TABLE_T LTE_Route26_MIPI_TX_EVENT_Set1[] =
{
   ...
   { /* 0  */ LTE_MIPI_PA  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_PA_TX_ON0_Set1  }, //PA On
   { /* 1  */ LTE_MIPI_PA  , { 4    , 5    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_PA_TX_OFF0_Set1 }, //PA Off
   { /* 2  */ LTE_MIPI_ASM , { 6    , 6    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ASM_TX_ON0_Set1 },
...
{
   //No.      elm type     , port_sel          , data_seq      , USID                        ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ {  18500/*100 kHz*/ ,0x00 , 0x7C }, {  18663/*100 kHz*/ ,0x00 , 0x7C }, {  18825/*100 kHz*/ ,0x00 , 0x7C }, {  18988/*100 kHz*/ ,0x00 , 0x7C }, {  19150/*100 kHz*/ ,0x00 , 0x7C },} }, // PA On PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ {  18500/*100 kHz*/ ,0x01 , 0x00 }, {  18663/*100 kHz*/ ,0x01 , 0x00 }, {  18825/*100 kHz*/ ,0x01 , 0x00 }, {  18988/*100 kHz*/ ,0x01 , 0x00 }, {  19150/*100 kHz*/ ,0x01 , 0x00 },} }, // PA path sel
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ {  18500/*100 kHz*/ ,0x03 , 0x00 }, {  18663/*100 kHz*/ ,0x03 , 0x00 }, {  18825/*100 kHz*/ ,0x03 , 0x00 }, {  18988/*100 kHz*/ ,0x03 , 0x00 }, {  19150/*100 kHz*/ ,0x03 , 0x00 },} }, // PA enable
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ {  18500/*100 kHz*/ ,0x04 , 0x10 }, {  18663/*100 kHz*/ ,0x04 , 0x10 }, {  18825/*100 kHz*/ ,0x04 , 0x10 }, {  18988/*100 kHz*/ ,0x04 , 0x10 }, {  19150/*100 kHz*/ ,0x04 , 0x10 },} }, // Iref
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_Set1    ,{ {  18500/*100 kHz*/ ,0x00 , 0x00 }, {  18663/*100 kHz*/ ,0x00 , 0x00 }, {  18825/*100 kHz*/ ,0x00 , 0x00 }, {  18988/*100 kHz*/ ,0x00 , 0x00 }, {  19150/*100 kHz*/ ,0x00 , 0x00 },} }, // Iref
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ {  18500/*100 kHz*/ ,0x04 , 0x00 }, {  18663/*100 kHz*/ ,0x04 , 0x00 }, {  18825/*100 kHz*/ ,0x04 , 0x00 }, {  18988/*100 kHz*/ ,0x04 , 0x00 }, {  19150/*100 kHz*/ ,0x04 , 0x00 },} }, // PA disable
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ {  18500/*100 kHz*/ ,0x05 , 0x05 }, {  18663/*100 kHz*/ ,0x05 , 0x05 }, {  18825/*100 kHz*/ ,0x05 , 0x05 }, {  18988/*100 kHz*/ ,0x05 , 0x05 }, {  19150/*100 kHz*/ ,0x05 , 0x05 },} }, // ASM PM_Trig: normal mode
   //{ /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0_Set1   ,{ {  18500/*100 kHz*/ ,0x01 ,0x01 }, {  18663/*100 kHz*/ ,0x01 ,0x01 }, {  18825/*100 kHz*/ ,0x01 ,0x01 }, {  18988/*100 kHz*/ ,0x01 ,0x01 }, {  19150/*100 kHz*/ ,0x01 ,0x01 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                           ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
//const LTE_MIPI_EVENT_TABLE_T LTE_Route27_MIPI_TX_EVENT_Set1[] =
//{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
  // { /* 0  */ LTE_MIPI_PA  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_Set1  }, //PA On
...
//const LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Route27_MIPI_TX_DATA_Set1[] =
//{
   //No.      elm type     , port_sel          , data_seq      , USID                       ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
//const LTE_MIPI_EVENT_TABLE_T LTE_Route28_MIPI_TX_EVENT_Set1[] =
//{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
  // { /* 0  */ LTE_MIPI_PA  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_Set1  }, //PA On
...
//const LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Route28_MIPI_TX_DATA_Set1[] =
//{
   //No.      elm type     , port_sel          , data_seq      , USID                       ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
  // { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_PA0_Set1   ,{ { 24960 /*100 kHz*/ ,0x00 , 0x3E}, { 25445 /*100 kHz*/  ,0x00 , 0x3E}, { 25930 /*100 kHz*/ ,0x00 , 0x3E}, { 26415 /*100 kHz*/ ,0x00 , 0x3E}, { 26900 /*100 kHz*/ ,0x00 , 0x3E},} }, // PA enable                             
  // { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_PA0_Set1   ,{ { 24960 /*100 kHz*/ ,0x01 , 0xB9}, { 25445 /*100 kHz*/  ,0x01 , 0xB9}, { 25930 /*100 kHz*/ ,0x01 , 0xB9}, { 26415 /*100 kHz*/ ,0x01 , 0xB9}, { 26900 /*100 kHz*/ ,0x01 , 0xB9},} }, // PA bias                               
...
const LTE_MIPI_EVENT_TABLE_T LTE_Route26_MIPI_TPC_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset    */
   /*                        { start, stop },                      ( us )        */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 2    }, LTE_MIPI_TPC_SET   , US2OFFCNT(12)  },
...
const LTE_MIPI_DATA_TABLE_T LTE_Route26_MIPI_TPC_DATA_Set1[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA0}, // PA On Band Select
   {/* 1  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA1}, // Data ref. by PA Section table idx 0
...
const LTE_MIPI_TPC_SECTION_TABLE_T LTE_Route26_MIPI_PA_SECTION_DATA_Set1[] =
{
   {
       18500, /*100kHz*/
      MIPI_USID_PA0_Set1, /*USID*/
