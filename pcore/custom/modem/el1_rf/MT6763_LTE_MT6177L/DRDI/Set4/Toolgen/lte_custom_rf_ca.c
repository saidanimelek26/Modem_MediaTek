...
const LTE_FE_RX_ROUTE_DATABASE_T LTE_FRONT_END_RX_ROUTE_DATABASE_Set4 =
{
   {
      /*Index  0*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR0,  Set4),
      /*Index  1*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR1,  Set4),
      /*Index  2*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR2,  Set4),
      /*Index  3*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR3,  Set4),
      /*Index  4*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR4,  Set4),
      /*Index  5*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR5,  Set4),
      /*Index  6*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR6,  Set4),
      /*Index  7*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR7,  Set4),
      /*Index  8*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR8,  Set4),
      /*Index  9*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR9,  Set4),
      /*Index 10*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR10, Set4),
      /*Index 11*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR11, Set4),
      /*Index 12*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR12, Set4),
      /*Index 13*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR13, Set4),
      /*Index 14*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR14, Set4),
      /*Index 15*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR15, Set4),
      /*Index 16*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR16, Set4),
      /*Index 17*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR17, Set4),
      /*Index 18*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR18, Set4),
      /*Index 19*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR19, Set4),
      /*Index 20*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR20, Set4),
      /*Index 21*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR21, Set4),
      /*Index 22*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR22, Set4),
      /*Index 23*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR23, Set4),
      /*Index 24*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR24, Set4),
      /*Index 25*/  LTE_ALTERNATE_FE_RX_SETTING(LTE_FE_RX_Route25, Set4),
      /*Index 26*/  LTE_ALTERNATE_FE_RX_SETTING(LTE_FE_RX_Route26, Set4),
   }
};

const LTE_FE_TX_ROUTE_DATABASE_T LTE_FRONT_END_TX_ROUTE_DATABASE_Set4 =
{
   {
      /*Index  0*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR0,  Set4),
      /*Index  1*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR1,  Set4),
      /*Index  2*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR2,  Set4),
      /*Index  3*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR3,  Set4),
      /*Index  4*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR4,  Set4),
      /*Index  5*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR5,  Set4),
      /*Index  6*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR6,  Set4),
      /*Index  7*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR7,  Set4),
      /*Index  8*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR8,  Set4),
      /*Index  9*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR9,  Set4),
      /*Index 10*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR10, Set4),
      /*Index 11*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR11, Set4),
      /*Index 12*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR12, Set4),
      /*Index 13*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR13, Set4),
      /*Index 14*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR14, Set4),
      /*Index 15*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR15, Set4),
      /*Index 16*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR16, Set4),
      /*Index 17*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR17, Set4),
      /*Index 18*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR18, Set4),
      /*Index 19*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR19, Set4),
      /*Index 20*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR20, Set4),
      /*Index 21*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR21, Set4),
      /*Index 22*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR22, Set4),
      /*Index 23*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR23, Set4),
      /*Index 24*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR24, Set4),
      /*Index 25*/  LTE_ALTERNATE_FE_TX_SETTING(LTE_FE_TX_Route25, Set4),
      /*Index 26*/  LTE_ALTERNATE_FE_TX_SETTING(LTE_FE_TX_Route26, Set4),
   }
};

const LTE_FE_CUSTOM_CA_LINKAGE_DATABASE_T LTE_FE_CA_LINKAGE_DATABASE_Set4 =
{
...
const LTE_FE_CUSTOM_CA_BAND_COMB_DATABASE_T LTE_FE_CA_BAND_COMB_DATABASE_Set4 =
{
...
const LTE_FE_CUSTOM_CCA_BAND_COMB_DATABASE_T LTE_FE_CCA_BAND_COMB_DATABASE_Set4 =
{
