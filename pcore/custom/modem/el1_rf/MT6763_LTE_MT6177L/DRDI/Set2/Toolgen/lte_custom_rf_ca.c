...
const LTE_FE_RX_ROUTE_DATABASE_T LTE_FRONT_END_RX_ROUTE_DATABASE_Set2 =
{
   {
      /*Index  0*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR0,  Set2),
      /*Index  1*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR1,  Set2),
      /*Index  2*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR2,  Set2),
      /*Index  3*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR3,  Set2),
      /*Index  4*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR4,  Set2),
      /*Index  5*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR5,  Set2),
      /*Index  6*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR6,  Set2),
      /*Index  7*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR7,  Set2),
      /*Index  8*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR8,  Set2),
      /*Index  9*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR9,  Set2),
      /*Index 10*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR10, Set2),
      /*Index 11*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR11, Set2),
      /*Index 12*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR12, Set2),
      /*Index 13*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR13, Set2),
      /*Index 14*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR14, Set2),
      /*Index 15*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR15, Set2),
      /*Index 16*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR16, Set2),
      /*Index 17*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR17, Set2),
      /*Index 18*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR18, Set2),
      /*Index 19*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR19, Set2),
      /*Index 20*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR20, Set2),
      /*Index 21*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR21, Set2),
      /*Index 22*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR22, Set2),
      /*Index 23*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR23, Set2),
      /*Index 24*/  LTE_SB_FE_RX_SETTING(BAND_INDICATOR24, Set2),
      /*Index 25*/  LTE_FE_RX_SPLIT_SETTING(BAND_SPLIT_INDICATOR0, Part2, Set2),
   }
};

const LTE_FE_TX_ROUTE_DATABASE_T LTE_FRONT_END_TX_ROUTE_DATABASE_Set2 =
{
   {
      /*Index  0*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR0,  Set2),
      /*Index  1*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR1,  Set2),
      /*Index  2*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR2,  Set2),
      /*Index  3*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR3,  Set2),
      /*Index  4*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR4,  Set2),
      /*Index  5*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR5,  Set2),
      /*Index  6*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR6,  Set2),
      /*Index  7*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR7,  Set2),
      /*Index  8*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR8,  Set2),
      /*Index  9*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR9,  Set2),
      /*Index 10*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR10, Set2),
      /*Index 11*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR11, Set2),
      /*Index 12*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR12, Set2),
      /*Index 13*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR13, Set2),
      /*Index 14*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR14, Set2),
      /*Index 15*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR15, Set2),
      /*Index 16*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR16, Set2),
      /*Index 17*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR17, Set2),
      /*Index 18*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR18, Set2),
      /*Index 19*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR19, Set2),
      /*Index 20*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR20, Set2),
      /*Index 21*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR21, Set2),
      /*Index 22*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR22, Set2),
      /*Index 23*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR23, Set2),
      /*Index 24*/  LTE_SB_FE_TX_SETTING(BAND_INDICATOR24, Set2),
      /*Index 25*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR0, Set2),
      /*Index 26*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR1, Set2),
      /*Index 27*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR2, Set2),
      /*Index 28*/  LTE_FE_TX_SPLIT_SETTING(BAND_SPLIT_INDICATOR0, Part2, Set2),
   }
};

const LTE_FE_CUSTOM_CA_LINKAGE_DATABASE_T LTE_FE_CA_LINKAGE_DATABASE_Set2 =
{
...
const LTE_FE_CUSTOM_CA_BAND_COMB_DATABASE_T LTE_FE_CA_BAND_COMB_DATABASE_Set2 =
{
...
const LTE_FE_CUSTOM_CCA_BAND_COMB_DATABASE_T LTE_FE_CCA_BAND_COMB_DATABASE_Set2 =
{
