...
{
   {
      ...
      /*Index 25*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR0, SetDefault),
      /*Index 26*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR1, SetDefault),
      /*Index 27*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR2, SetDefault),
      /*Index 28*/  LTE_FE_TX_SPLIT_SETTING(BAND_SPLIT_INDICATOR0, Part2, SetDefault),
   }
};
