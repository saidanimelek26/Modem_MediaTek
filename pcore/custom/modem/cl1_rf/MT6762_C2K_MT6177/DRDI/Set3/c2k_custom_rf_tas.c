...
C2K_MIPI_EVENT_TABLE_T CL1D_RF_CUST_TAS_EVENT_CAT_A_Route0_Set3[C2K_MIPI_TAS_EVENT_NUM] =
{
   ...
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ C2K_MIPI_TAS ,   { 0    , 0    }, C2K_MIPI_TRX_ON       ,    MIPI_TAS_ON_Set3 },
...
C2K_MIPI_DATA_SUBBAND_TABLE_T CL1D_RF_CUST_TAS_DATA_CAT_A_Route0_Set3[C2K_MIPI_TAS_DATA_NUM] =
{
   ...
   { /* 0  */ C2K_MIPI_TAS , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_TAS_Set3   , { { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} } } },
...
C2K_MIPI_DATA_SUBBAND_TABLE_T CL1D_RF_CUST_TAS_DATA_CAT_A_Route1_Set3[C2K_MIPI_TAS_DATA_NUM] =
{
   ...
   { /* 0  */ C2K_MIPI_TAS , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_TAS_Set3   , { { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} } } } ,
   { /* 1  */ C2K_MIPI_TAS , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_TAS_Set3   , { { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} }, { 00000 /*100 kHz*/ , {0x00 ,0x00} } } } ,
...
C2K_MIPI_EVENT_TABLE_T CL1D_RF_CUST_TAS_EVENT_CAT_B_Route0_Set3[C2K_MIPI_TAS_EVENT_NUM] =
{
   /* No.       elm type             , data idx            , evt_type                   , evt_offset             */
   /*                                     { start, stop },                                        ( us )                 */
   { /* 0  */ C2K_MIPI_TAS , { 0    , 0    }, C2K_MIPI_TRX_OFF    , MIPI_TAS_ON_Set3 },
   { /* 1  */ C2K_MIPI_NULL, { 0    , 0    }, C2K_MIPI_EVENT_NULL, 0                          },
};
...
C2K_MIPI_EVENT_TABLE_T CL1D_RF_CUST_TAS_EVENT_CAT_C_Route2_Set3[C2K_MIPI_TAS_EVENT_NUM ] =
{
   ...
   /*                                     { start, stop },                                        ( us )                 */
   { /* 0  */ C2K_MIPI_TAS , { 0    , 0    }, C2K_MIPI_TRX_OFF    , MIPI_TAS_ON_Set3 },
   { /* 1  */ C2K_MIPI_TAS , { 1    , 1    }, C2K_MIPI_TRX_ON    , MIPI_TAS_ON_Set3},
   { /* 2  */ C2K_MIPI_NULL, { 0    , 0    }, C2K_MIPI_EVENT_NULL, 0                          },
};
