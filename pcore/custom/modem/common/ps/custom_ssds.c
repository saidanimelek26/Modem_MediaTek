                                             ...
                                             kal_char *mccmnc )
{
    ...
    kal_uint32 atcmd_request_ps_only_table[] = {01, 02, 03, 05, 06, 07, 9, 15, 16, 18, 19, 50, 107,
                                                117, 120, 145, 148, 154, 157, 196, 201, 221, 224};
    kal_uint32 index;
    ...
    /*Special case for H3G-Sweden/H3G-Denmark/Rogers-Canada Entel/Chile TIM/Brazil: support XCAP only or 2/3/4G*/
    if((0 == (kal_mem_cmp(mccmnc, "24002", 5))) || (0 == (kal_mem_cmp(mccmnc, "23806", 5))) || (0 == (kal_mem_cmp(mccmnc, "22201", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "302370", 6))) || (0 == (kal_mem_cmp(mccmnc, "302720", 6))) || (0 == (kal_mem_cmp(mccmnc, "21603", 5))) ||
...
kal_bool  _custom_ssds_cs_only_path_variable(kal_uint32 op_id,
                                             kal_char *mccmnc)
{
    kal_uint32 atcmd_request_cs_only_table[] = { 17, 20, 100, 101, 102, 104, 106, 108, 110, 111, 114, 115, 116, 122,
                                                 125, 126, 127, 131, 135, 143, 147, 149, 151, 163, 165, 176, 183,
                                                 184, 187, 188, 189, 191, 192, 210, 211, 245};
    kal_uint32    index;
    kal_bool      ret_value = KAL_FALSE;
                                             ...
                                             )
{
    if ((0 == (kal_mem_cmp(mccmnc, "23415", 5))) || (0 == (kal_mem_cmp(mccmnc, "23591", 5))) ||
        ...
        (0 == (kal_mem_cmp(mccmnc, "73002", 5))) || (0 == (kal_mem_cmp(mccmnc, "302610", 6)))||
        (0 == (kal_mem_cmp(mccmnc, "302370", 6)))|| (0 == (kal_mem_cmp(mccmnc, "302720", 6)))||
    ...
    if ((op_id == 3) || (op_id == 5) || ((op_id == 7)&&(0!=(kal_mem_cmp(mccmnc, "334090", 6)))&&(0!=(kal_mem_cmp(mccmnc, "334050", 6)))) || (op_id == 8) ||
        ...
        (op_id == 117) || (op_id == 118) || (op_id == 124) || (op_id == 127) || (op_id == 128) || (op_id == 129) || (op_id == 134) ||
        (op_id == 135) || (op_id == 148) || (op_id == 150) || (op_id == 152) || (op_id == 161) || (op_id == 103) || (op_id == 145) ||
        (op_id == 154) || (op_id == 162) || (op_id == 181) || (op_id == 196) || (op_id == 199) || (op_id == 219) ||
    ...
    else if ((op_id == 9) || (0 == (kal_mem_cmp(mccmnc, "73001", 5))) || (0 == (kal_mem_cmp(mccmnc, "73010", 5))))
    {
        *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_NOT_SUPPORT_409;
        ...
        (0 == (kal_mem_cmp(mccmnc, "22201", 5))) || (0 == (kal_mem_cmp(mccmnc, "24002", 5))) ||
        ...
        (0 == (kal_mem_cmp(mccmnc, "22288", 5))))
    {
        ...
        {/* special for CHT and VHA and TIM/Italy and Denmark/Telenor and Telekom/Slovenia:CLIR terminal based */
            if (CUSTOM_SSDS_ATCMD_TYPE_SET_CLIR == atcmd_info->atcmd_type)
            {
                *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY_ALWAYS;
            }
    ...
    else if ((op_id == 111) || (op_id == 147) || (op_id == 186) || (op_id == 210) || (op_id == 232) ||
        (0 == (kal_mem_cmp(mccmnc, "41006", 5))))
    {/* For Voda-IND, Airtel-IND, Idea-IND, BSNL-IND, Mobitel-Srilanka, Telenor-Pakistan:
        ...
        (op_id == 18) ||  (op_id == 116)|| (0 == (kal_mem_cmp(mccmnc, "70401", 5)))||(0 == (kal_mem_cmp(mccmnc, "70402", 5))))
    {
       *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_OPERATION_NOT_SUPPORTED_4;
       return  KAL_TRUE;
    }
                                           ...
                                           )
{
	...
	else if((op_id == 7)||(op_id == 145)||(op_id == 196)||(0 == (kal_mem_cmp(mccmnc, "73002", 5)))||(0 == (kal_mem_cmp(mccmnc, "20416", 5)))||
        (0 == (kal_mem_cmp(mccmnc, "20420", 5)))||(0 == (kal_mem_cmp(mccmnc, "20404", 5))))
    {/* Per AT&T SME, Movistar/Chile, DTAG/Netherlands, VDF/Netherlands Call barring should not be supported in XCAP/Ut */
        *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY;
        return  KAL_TRUE;
    }
    else if((op_id == 8)||(0 == (kal_mem_cmp(mccmnc, "302720", 6)))||(0 == (kal_mem_cmp(mccmnc, "302370", 6))) ||
        (op_id == 114)||(op_id == 115)||(op_id == 116)||(op_id == 157)||(op_id == 201)||(0 == (kal_mem_cmp(mccmnc, "24214", 5))))
    {/* Per TMOUS Spec and Rogers/Canada, ICE/Norway and KPN Netherlands Call barring should not be supported in XCAP/Ut and CS domain */
        *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_OPERATION_NOT_SUPPORTED_4;
        return  KAL_TRUE;
    }
                                           ...
                                           )
{
     ...
     * VHA(153, if WFC registered and RF OFF), Telkomsel/Indonesia(224) */
    if ((op_id == 16) || (op_id == 104) || (op_id == 109) || (op_id == 122) || (op_id == 125) || (op_id == 131) ||
        (op_id == 135) ||(op_id == 143) || (op_id == 157) || (op_id == 200) || (op_id == 201) || (op_id == 211) || 
        (op_id == 224) ||
     ...
     * RJIO-IND(18), Telenor-Mynmar(41406)
     */
    if ((op_id == 18) ||
        (0 == (kal_mem_cmp(mccmnc, "41406", 5))))
    {
                                         ...
                                         )
{
    ...
    if (ims_domain == CUSTOM_SSDS_IMS_DOMAIN_TYPE_WFC)
    {
        ...
        if (((op_id == 11) && (0 != (kal_mem_cmp(mccmnc, "23205", 5))) && (0 != (kal_mem_cmp(mccmnc, "23210", 5))) &&
            ...
            (0 == (kal_mem_cmp(mccmnc, "22288", 5))) || (0 == (kal_mem_cmp(mccmnc, "21405", 5))) ||
            (0 == (kal_mem_cmp(mccmnc, "21407", 5))))
        {
            *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY;
            return  KAL_TRUE;
                                                         ...
                                                         )
{
   ...
   if(KAL_TRUE == _custom_ssds_ps_only_path_variable(op_id, req_info->mccmnc))
   {
    ...
    {
        /* Movistar Argentina , Play/Poland will chose CS when data off*/
        /* Movistar/Mexico(334030, 33403) Movistar/Peru(71606) will chose PS when data off */
        if((op_id == 132 && (!(0 == (kal_mem_cmp(req_info->mccmnc, "334030", 6))))&&(!(0 == (kal_mem_cmp(req_info->mccmnc, "33403", 5))))&&
            (!(0 == (kal_mem_cmp(req_info->mccmnc, "71606", 5)))))||(0 == (kal_mem_cmp(req_info->mccmnc, "37001", 5))))
        {
            atcmd_path_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY;
        }
    }
    ...
    if(CUSTOM_SSDS_ROAMING_TYPE_NO != roaming_status)
    {
        /*Optus Australia, Umobile, Sky UK , Avantel/Colombia ,Vodafone/Egypt, Wind/Italy,
          Freedom/Canada, Mobitel-Srilanka,Movistar/Colombia do not support Ut/XCAP in roaming NW;
        ...
        if((op_id == 152)||(op_id == 189)||(op_id == 206)||(op_id == 209)|| (op_id == 219) || (op_id == 162) ||
           (op_id == 232) || ((KAL_TRUE == req_info->is_ct_card) && (0 == (kal_mem_cmp(req_info->mccmnc, "20404", 5))))||
           (0 == (kal_mem_cmp(req_info->mccmnc, "60202", 5))) || (0 == (kal_mem_cmp(req_info->mccmnc, "22288", 5)))||
           (0 == (kal_mem_cmp(req_info->mccmnc, "37001", 5)))||(0 == (kal_mem_cmp(req_info->mccmnc, "732123", 6))))
        {
            atcmd_path_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY;
        }
                                           ...
                                           kal_bool                     *trigger_ims_dereg)
{
    ...
    /* Telefonica requires that after UE receives 40x error response (other than 403) from NW, it needs to CSFB */
    else if(op_id == 15)
    {
        if (403 == rsp_id)
        {
...
kal_bool ssds_need_retry_default_apn(module_type module_id,kal_uint32  op_id,kal_char *mccmnc)
{
    ...
    if(KAL_TRUE == sbp_query_md_feature_by_ps(SBP_NOT_TRY_DEFAULT_APN_FOR_SS,(protocol_id_enum)(module_id - MOD_SSDS))
       || (op_id == 5) || (op_id == 109) || (op_id == 219) ||
       (0 == (kal_mem_cmp(mccmnc, "23415", 5))))
                                                    ...
                                                    custom_ssds_ims_domain_type ims_domain)
{
    ...
    /* M1(Singapore) */
    if(op_id == 151 && ims_domain == CUSTOM_SSDS_IMS_DOMAIN_TYPE_WFC)
    {
...
kal_bool custom_ssds_cdma_only(kal_uint32 op_id, kal_char *mccmnc)
{
    return _custom_ssds_cdma_only_path_variable(op_id, mccmnc);
}
