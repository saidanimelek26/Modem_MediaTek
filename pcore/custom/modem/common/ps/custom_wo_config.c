 ...
 */
kal_bool custom_wo_cfg_get(wo_cfg_t *p_cfg, kal_uint8 ps_id, kal_uint32 sbp_id,
    ...
    switch (sbp_id)
    {
        ...
        case 15: /* Telefonica (O2) */
        {
            if (streq(mcc, "234")) {
                ...
                kal_snprintf((kal_char *)p_cfg->ike_algo, sizeof(p_cfg->ike_algo), "%s",
                             "aes256-sha512-prfsha256-modp4096-modp2048");
                kal_snprintf((kal_char *)p_cfg->esp_algo, sizeof(p_cfg->esp_algo), "%s",
        ...
        {
            kal_snprintf((kal_char *)p_cfg->ike_algo, sizeof(p_cfg->ike_algo), "%s",
                         "aes128-aes256-3des-des-sha1-sha256-sha384-sha512-md5-aesxcbc-prfsha1-prfmd5-prfaesxcbc-prfsha256-prfsha384-prfsha512-modp1024-modp768-modp1536-modp2048-modp3072-modp4096!");
            kal_snprintf((kal_char *)p_cfg->esp_algo, sizeof(p_cfg->esp_algo), "%s",
                         "aes128-aes256-3des-des-null-sha1-md5-aesxcbc!");
            p_cfg->device_identity = 1;
            break;
        }
        case 112: /* Telcel */
        ...
        case 178: /* Smart */
        {
            if (streq(mcc, "515")) {
                /*Philippines*/
                kal_snprintf((kal_char *)p_cfg->epdg_fqdn, sizeof(p_cfg->epdg_fqdn), "%s",
                             "epdg01.epc.mnc003.mcc515.pub.3gppnetwork.org");
                kal_snprintf((kal_char *)p_cfg->ike_algo, sizeof(p_cfg->ike_algo), "%s",
        ...
        {
            kal_snprintf((kal_char *)p_cfg->ike_algo, sizeof(p_cfg->ike_algo), "%s",
                         "aes-3des-null-sha1-md5-prfsha1-modp1024");
            kal_snprintf((kal_char *)p_cfg->esp_algo, sizeof(p_cfg->esp_algo), "%s",
                         "aes-3des-null-sha1-md5!");
            p_cfg->mobike = 1;
            p_cfg->cust_pcscf_4 = 16384;
            p_cfg->cust_pcscf_6 = 16386;
            break;
