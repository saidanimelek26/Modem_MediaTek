...
#ifdef __TFN_SIMLOCK__
extern nvram_ef_smu_tfn_obj_struct *pTFNg;
#endif
...
#endif
#ifdef __TFN_SIMLOCK__
extern void sml_init_tfn_obj(void );
extern kal_uint16 sml_tfn_Load(void * pLid);
extern kal_uint16 sml_tfn_Save(void * pLid);
extern kal_uint8 custom_sml_tfn_get_tfn_efuse_bit();
extern void sml_fill_tfn_simlock_obj(kal_uint8 source , sml_cat_enum cat);
extern void sml_fill_sml_obj_with_tfn_data(kal_uint8 source);
