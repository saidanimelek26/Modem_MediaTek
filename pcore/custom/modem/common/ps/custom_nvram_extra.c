    ...
    switch(file_idx)
    {
        ...
        case NVRAM_EF_L4_CARRIER_RESTRICTION_LID:
         ...
         case NVRAM_EF_L4_TFN_SIMLOCK_LID:
            ...
            return sizeof(nvram_ef_l4_tfn_simlock_struct);
...
#ifdef __TFN_SIMLOCK__
static void sml_tfn_give(void * pLidToObj);
static void sml_tfn_take(void * pObjToLid);
static void sml_tfn_destory(void );
static void * sml_tfn_getItem(sml_cat_enum category,sml_ctx_enum item,kal_uint16 * plength);
static void sml_tfn_putItem(sml_cat_enum cat,sml_ctx_enum item,void * pItem,kal_uint16 * plength);
...
#ifdef __TFN_SIMLOCK__
static sml_context_tfn_struct sml_tfn_cntxt_obj;
static nvram_ef_smu_tfn_obj_struct TFNOBJ;
#endif
...
#ifdef __TFN_SIMLOCK__
/* define the Global access pointer of TFN simlock object */
nvram_ef_smu_tfn_obj_struct * pTFNg = &TFNOBJ;
#endif
...
#ifdef __TFN_SIMLOCK__
void sml_init_tfn_obj()
{
    nvram_ef_smu_tfn_obj_struct sml_tfn_obj = {
           NULL,
           sml_tfn_give,
           sml_tfn_take,
           sml_tfn_destory,
       ...
       kal_mem_cpy(&TFNOBJ, &sml_tfn_obj, sizeof(nvram_ef_smu_tfn_obj_struct));
 ...
 *  sml_tfn_Load
 * DESCRIPTION
 *  This function loads the TFN carrier restriction obj from NVRAM LID (NVRAM_READ_CNF)
 * PARAMETERS
 *  IN          pLid
 * RETURN
 *  kal_uint16  Obj size
 ...
 *  SMU_CRRST_OBJ
 *******************************************************************************/ 
kal_uint16 sml_tfn_Load( void *pLid )
{
    nvram_ef_smu_tfn_obj_struct *p = &TFNOBJ;

    kal_uint16 length = sizeof(nvram_ef_smu_tfn_obj_struct);
 ...
 *  sml_tfn_give
 * DESCRIPTION
 *  This method copys the LID files read from NVRAM to the SML_TFN_OBJ
 * PARAMETERS
 *  IN          * pLidToObj
 * RETURN
 *  void
...
static void sml_tfn_give(void *pLidToObj)
{
    sml_context_tfn_struct * pObj = NULL;
    ...
    pObj = &(sml_tfn_cntxt_obj);

    kal_mem_cpy(pObj,
                pLidToObj,
                sizeof(sml_context_tfn_struct)
                ); 
 ...
 *  sml_tfn_take
 * DESCRIPTION
 *  This method copys the context of the SML_TFN_OBJ to the provided NVRAM LID.
 * PARAMETERS
 *  OUT         * pObjToLid
 * RETURN
 *  void
...
static void sml_tfn_take(void *pObjToLid)
{
    sml_context_tfn_struct * pObj = (sml_context_tfn_struct *) pTFNg->pObj;
 ...
 *  sml_tfn_destory
 * DESCRIPTION
 *  This method free the SML_TFN_OBJ in memory if it is not used.
 * PARAMETERS
 *  void
 * RETURN
 *  void
 ...
 * DESCRIPTION
 *  This method returns the structure pointer and length of the structure
 *  of the desired SML_TFN_OBJ items.
 * PARAMETERS
 *  IN          cat
 *  IN          item
 *  OUT         *length
 ...
 *  SML_MRC_OBJ
 *******************************************************************************/
static void * sml_tfn_getItem(sml_cat_enum category,
                           sml_ctx_enum item,
                           kal_uint16 *plength)
{
    sml_context_tfn_struct *pObj = (sml_context_tfn_struct *) pTFNg->pObj;
            ...
            *plength = sizeof(SML_CTRL_KEY_STRUCT);
            ...
            switch(category)
            {
                ...
                case SML_CAT_SP:
                    ...
                    return (SML_CTRL_KEY_STRUCT *) &(pObj->key[0]);
                ...
                case SML_CAT_C:
                    ...
                    return (SML_CTRL_KEY_STRUCT *) &(pObj->key[1]);
 ...
 *  sml_tfn_putItem
 * DESCRIPTION
 *  This method set the desired items of the SML_TFN_OBJ
 * PARAMETERS
 *  IN          cat
 *  IN          item
 *  IN          *pItem
 ...
 *  SML_TFN_OBJ
 *******************************************************************************/ 
static void sml_tfn_putItem(sml_cat_enum cat,
                         sml_ctx_enum item, 
                         void *pItem,
                         kal_uint16 *plength)
{
 ...
 *  SMLOBJ
 *******************************************************************************/ 
kal_uint16 sml_tfn_Save(void *pLid )
{
    nvram_ef_smu_tfn_obj_struct *p = &TFNOBJ;

    kal_uint16 length = sizeof(sml_context_tfn_struct);
...
void sml_fill_tfn_simlock_obj(kal_uint8 source , sml_cat_enum cat)
{

    nvram_ef_sml_obj_struct *p  = &pSMLg[source];
    nvram_ef_smu_tfn_obj_struct *p_tfn = pTFNg;
    kal_uint16 length = 0;
    SML_CTRL_KEY_STRUCT *catkey = NULL;
    SML_CTRL_KEY_STRUCT *tfn_catkey = NULL;
    kal_uint8  *catcode = NULL;
    kal_uint8  *tfn_catcode = NULL;

    
    catkey = (SML_CTRL_KEY_STRUCT *) (*p->getItem)(cat,SML_CAT_KEY,&length, source);
    catcode = (kal_uint8 *) (*p->getItem)(cat,SML_CAT_CODE,&length, source);
    
    tfn_catkey = (SML_CTRL_KEY_STRUCT *) (*p_tfn->getItem)(cat,SML_CAT_KEY,&length);
    tfn_catcode = (kal_uint8 *) (*p_tfn->getItem)(cat,SML_CAT_CODE,&length);

    kal_brief_trace(TRACE_INFO, INFO_SML_COPY_DATA_TO_TFN);
    kal_mem_cpy(tfn_catkey,catkey,sizeof(sml_control_key_s_struct));
    kal_mem_cpy(tfn_catcode, catcode, length);
}

void sml_fill_sml_obj_with_tfn_data(kal_uint8 source)
{
    nvram_ef_sml_obj_struct *p  = &pSMLg[source];
    nvram_ef_smu_tfn_obj_struct *p_tfn = pTFNg;
    kal_uint16 length = 0;
    ...
    kal_brief_trace(TRACE_INFO, INFO_SML_COPY_DATA_FROM_TFN);
    
    /*CopySP data */
    catkey = (SML_CTRL_KEY_STRUCT *) (*p->getItem)(SML_CAT_SP,SML_CAT_KEY,&length, source);
    catcode= (kal_uint8 *) (*p->getItem)(SML_CAT_SP,SML_CAT_CODE,&length, source);

    tfn_catkey = (SML_CTRL_KEY_STRUCT *) (*p_tfn->getItem)(SML_CAT_SP,SML_CAT_KEY,&length);
    tfn_catcode = (kal_uint8 *) (*p_tfn->getItem)(SML_CAT_SP,SML_CAT_CODE,&length);


    kal_mem_cpy(catkey,tfn_catkey ,sizeof(sml_control_key_s_struct));
    kal_mem_cpy(catcode,tfn_catcode ,length);
    


    /*copy CP data*/
    catkey = (SML_CTRL_KEY_STRUCT *) (*p->getItem)(SML_CAT_C,SML_CAT_KEY,&length, source);
    catcode= (kal_uint8 *) (*p->getItem)(SML_CAT_C,SML_CAT_CODE,&length, source);

    tfn_catkey = (SML_CTRL_KEY_STRUCT *) (*p_tfn->getItem)(SML_CAT_C,SML_CAT_KEY,&length);
    tfn_catcode = (kal_uint8 *) (*p_tfn->getItem)(SML_CAT_C,SML_CAT_CODE,&length);
...
kal_uint8 sml_uicc_lock_get_list_num(kal_uint8 lock_code)
{
    if (lock_code == 0)
    {
