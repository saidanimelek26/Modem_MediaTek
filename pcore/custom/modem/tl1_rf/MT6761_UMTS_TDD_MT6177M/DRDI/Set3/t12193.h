...
//ENABLE_DOWNLINK_TIMING_DEFAULT[60]
{
    ...
    MIPI_DEVICE3_RX_ENABLE_Set3     , -560,//ant tune
...
//DISABLE_DOWNLINK_TIMING_DEFAULT[60]=
{
    ...
    MIPI_DEVICE3_RX_DISABLE_Set3    ,  60,//ant tune
#ifdef TAS_CAT_A_B_MIPI_TIMING_EXPANSION
...
//ENABLE_UPLINK_TIMING_DEFAULT[60]=
{
    ...
    SRX_RELOCK_Set3                 , -640,
    VPA_ENABLE_Set3                 , -230,
    MIPI_DEVICE3_TX_ENABLE_Set3     , -220,//ant tune
...
//DISABLE_UPLINK_TIMING_DEFAULT[60]=
{
    ...
    MIPI_DEVICE3_TX_DISABLE_Set3   ,   -40,//ant tune
#ifdef TAS_CAT_A_B_MIPI_TIMING_EXPANSION
...
//DL_DL_GAP_CTRL_TIMING_DEFAULT[60]=
{
    ...
    MIPI_DEVICE3_RX_ENABLE_Set3     , -190,//ant tune
#ifdef TAS_CAT_A_B_MIPI_TIMING_EXPANSION
...
{
   // MIPI_DEVICE3_TX_DISABLE_Set3   ,    0,//ant tune
    ADC_ENABLE_Set3                ,    0,
    RXE_CFG_Set3                   ,    0,
    RXE_WIN_ON_Set3                ,    0,
    RXE_TICK_SET_Set3              ,    0,
