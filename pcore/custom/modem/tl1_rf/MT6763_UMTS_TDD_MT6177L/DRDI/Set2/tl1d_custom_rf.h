...
//T_BPI_SETTING
{
    ...
    ////////////TAS//////////////////////////////////////////////////RFconflict////////////////////////////
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (1<<9) + (1<<11) + (1<<12)+ (1<<13)+ (1<<14)+ (1<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_CTRL_BITMASK   data[1] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (0<<7) + (0<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G34 PA_HGAIN  data[2] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (0<<7) + (0<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G34 PA_MGAIN  data[3] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (0<<7) + (0<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G34 PA_LGAIN  data[4] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (0<<7) + (1<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G01 PA_HGAIN  data[5] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (0<<7) + (1<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G01 PA_MGAIN  data[6] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (0<<7) + (1<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G01 PA_LGAIN  data[7] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (1<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_1G90 PA_HGAIN  data[8] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (1<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_1G90 PA_MGAIN  data[9] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (1<<9) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_1G90 PA_LGAIN  data[10] //ANT
    ...
    /////////////TAS////////////////////RFconflict/////////////////////////////////////////////////////////
        ...
        (0)    +(1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),                               //RX_2G01           data[14] //ANT
        (0)    +(1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),                               //RX_1G90           data[15] //ANT
...
//T_RF_PORT_SEL
{
    TDS_TX_MB2_Set2,  //Tx2G01
    TDS_TX_MB2_Set2,  //Tx1G90
    TDS_TX_MB2_Set2,  //Tx2G34
