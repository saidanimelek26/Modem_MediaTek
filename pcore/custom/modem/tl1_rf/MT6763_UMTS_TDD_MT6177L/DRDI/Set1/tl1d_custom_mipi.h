...
const T_MIPI_CUSTOMIZATION_STRUCT AST_TL1_RFFE_PARAMETER_DEFAULT_Set1[] ={
{
    ...
    /*Data Num Do Not Exceed 8 for Each Scenario*/
    {
        {
            /*                MODULE    ,          PORT         ,     OPERATION ,          USID                   , ADDR, DATA*/
            {/* 0*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x00, 0x8F },//PA HIGH MODE
            {/* 1*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x01, 0x8E },//PA HIGH MODE
            {/* 2*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x04, 0x10 },//PA HIGH MODE
            {/* 3*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x02, 0x00 },//PA HIGH MODE
            {/* 4*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    },//PA HIGH MODE
            {/* 5*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    },//PA HIGH MODE
            {/* 6*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    },//PA HIGH MODE
            {/* 7*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    }//PA HIGH MODE                                                                                                                                                                 
        ...
        {
            /*                MODULE    ,          PORT         ,     OPERATION ,          USID                   , ADDR, DATA*/
            {/* 0*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x00, 0xAF },//PA MIDDLE MODE
            {/* 1*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x01, 0x28 },//PA MIDDLE MODE
            {/* 2*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x04, 0x10 },//PA MIDDLE MODE
            {/* 3*/ TDD_PA_Set1   , MIPI_PORT0_Set1 , TDSCDMA_REG_W , TDD_PA_USID_BAND39_Set1   , 0x02, 0x00 },//PA MIDDLE MODE
            {/* 4*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    },//PA MIDDLE MODE
            {/* 5*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    },//PA MIDDLE MODE
            {/* 6*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    },//PA MIDDLE MODE
            {/* 7*/ DATA_NULL_Set1, 0                     , 0             , 0                               , 0   , 0    }//PA MIDDLE MODE      
