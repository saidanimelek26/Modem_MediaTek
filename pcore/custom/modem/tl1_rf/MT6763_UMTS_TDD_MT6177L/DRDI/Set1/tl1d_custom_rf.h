...
//T_BPI_SETTING
{
    ...
    ////////////TAS//////////////////////////////////////////////////RFconflict////////////////////////////
        ...
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G01 PA_HGAIN  data[5] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G01 PA_MGAIN  data[6] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_2G01 PA_LGAIN  data[7] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_1G90 PA_HGAIN  data[8] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_1G90 PA_MGAIN  data[9] //ANT
        (0)    +(1<<0) + (1<<2) + (1<<5)+ (1<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (1<<16)+ (1<<17) + (1<<31),     //TX_1G90 PA_LGAIN  data[10] //ANT
