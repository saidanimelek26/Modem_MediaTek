...
/***************************************************************************** 
   Below enum is used as a tag for ELT tool to recognize MCDDLL view version.
   Version 2 means the load is for MT6291 or after (include universal bin modification), 
   and ELT may use different in-tool decoder file 
   Only MCDDLL contact window and tool team can modify this enum 
******************************************************************************/
typedef enum
{
    MCDDLL_Version = 2 // 2 for the new MCDDLL file from MT6291
} MCDDLL_Version_Info;
