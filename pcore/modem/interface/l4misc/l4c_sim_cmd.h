...
extern kal_bool l4c_sim_card_type_switch_req(kal_uint8 src_id, kal_uint8 application_id);
...
extern kal_bool l4c_sat_setup_ussd(kal_bool send_over_ims);
...
extern void l4c_sim_submodule_reread_req(void);
...
extern kal_bool l4c_smu_sl_update_blob_req(kal_uint8 src_id, sml_custom_op_enum op, kal_uint16 slb_len, kal_uint8 *slb);
