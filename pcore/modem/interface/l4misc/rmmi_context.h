...
#if 0    // move to l4c_phb_context_struct
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    ************************************************/
    ...
    kal_uint8 is_esims_test; // Allow Consecutive AT+ESIMS for factory test
...
/*************************************************************************/
    ...
    //rmmi_phb_type_enum phb_storage_type;  // move to l4c_phb_context_struct
...
//#endif
    ...
    //rmmi_phb_info_struct phb_info;    // move items in rmmi_phb_info_struct to l4c_phb_context_struct
...
/* under construction !*/
...
#if defined(__MULTIPLE_PS__) || defined(__L4C_GPRS_UT__)
    ...
    // for E911
    rat_enum last_emcss_available_rat;
#ifdef __IMS_SUPPORT__
    ...
    kal_bool enable_ecell_cell_id_check;
    kal_uint32 cell_id;
    ...
    kal_uint8 emcss_trans_id;//transaction id for AT+EMCSS
