...
extern void l4c_nw_iwlan_pwl_thrhd_start_timer_hdlr(l4c_pwl_thrhd_timer_id_enum timer, kal_uint8 time);
extern void l4c_nw_iwlan_pwr_level_ind_hdlr(kal_uint8 signal_status, kal_int32 sig_value_in_qdbm, l4c_sig_type_enum sig_type);
