...
typedef enum
{
   ...
   EVDL_DATA_AVAILABLE,
   EVDL_CHANNEL_STATUS,                   /* 10 (0x0A) */
   EVDL_ACCESS_TECHNOLOGY_CHANGE,
   EVDL_DISPLAY_PARAMETER_CHANGE,
   EVDL_LOCAL_CONNECTION,
   EVDL_NW_SEARCH_MODE_CHANGE,
   EVDL_BROWSING_STATUS,
   EVDL_FRAME_INFO_CHANGE,                /* 16 (0x10) */
   EVDL_IWLAN_ACCESS_STATUS,
   EVDL_NW_REJECT,
   EVDL_HCI_CONNECTIVITY,
   EVDL_ACCESS_TECHNOLOGY_CHANGE_MULTI,   /* 20 (0x14) */
   EVDL_CSG_CELL_CELECTION,
   EVDL_CONTACTLESS_STATE_REQUEST,
   EVDL_IMS_REGISTRATION,
   EVDL_INCOMING_IMS_DATA,
   EVDL_POLL_INTERVAL_NEGOTIATION         = 0x1C,
   EVDL_DATA_CONNECTION_STATUS_CHANGE,
...
typedef enum
{
   ...
   TYPE_LANGUAGE_SET,
   TYPE_TIMING_ADVANCE,
   TYPE_ACCESS_TECHNOLOGY,
   TYPE_ESN,
   TYPE_IMEISV,
   TYPE_NW_SEARCH_MODE,
   TYPE_CHARGE_STATE_OF_BATTERY,
   TYPE_MEID
}sat_local_info_enum;
...
typedef enum
{
    ...
    SIM_CHV1_COUNT_OFS   = 0x12,
    SIM_UBCHV1_COUNT_OFS = 0x13,
    SIM_CHV2_COUNT_OFS   = 0x14,
    SIM_UBCHV2_COUNT_OFS = 0x15
}sim_fci_offset_enum;
...
typedef enum
{
    SIM_CDMA_DETECT_NO_ERR,
    SIM_CDMA_DETECT_ATR_ERR,
    SIM_CDMA_DETECT_APDU_LOST_ERR,
    SIM_CDMA_DETECT_PLUG_OUT_ERR,
    SIM_CDMA_DETECT_INVALID_ERR
}sim_cdma_detect_err_type;
...
typedef enum
{
    SIM_EUICC_DETECT_NO_ERR,
    SIM_EUICC_DETECT_ATR_ERR,
    SIM_EUICC_DETECT_APDU_LOST_ERR,
    SIM_EUICC_DETECT_PLUG_OUT_ERR,
    SIM_EUICC_DETECT_INVALID_ERR
}sim_euicc_detect_err_type;
#endif
