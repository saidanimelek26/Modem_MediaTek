...
typedef enum
{
    UEM_RF_TEST_NOT_RUNNING = 0,  //to check whether rx/tx test is running or not
    UEM_RF_TEST_RUNNING 
} uem_rf_test_running_status_enum;
...
typedef struct
{
    ...
    uem_rf_test_running_status_enum is_rf_test_running; //to know whether rx/tx test is running or not
} uem_context_struct;
