...
extern void rmmi_bt_error_recover(
                rmmi_bt_action_enum act,
                bt_error_reason_enum cause,
                bt_gateway_status_enum bc_state,
                bt_sco_status_enum sco);
...
extern void l4c_bt_pwron_req(
                kal_uint8 src_id,
                kal_uint8 *my_bd_addr,
                kal_uint8 *name,
                kal_uint8 visibility,
                bt_authenticate_type_enum auth);
...
extern void l4c_bt_set_pin_req(
                kal_uint8 src_id,
                kal_uint32 handle,
                kal_uint8 idx,
                kal_uint8 *bd_addr,
...
extern void l4c_bt_page_req(
                kal_uint8 src_id,
                kal_uint8 source,
                kal_uint8 idx,
                kal_uint8 *bd_addr,
                bt_authenticate_type_enum auth,
                bt_profile_enum prof);
