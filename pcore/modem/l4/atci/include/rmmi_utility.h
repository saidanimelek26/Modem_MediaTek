...
extern ddm_source_id_enum l4c_ps_map_l4c_src_id_to_ddm_src_id(l4c_source_id_enum l4c_src_id);

extern l4c_source_id_enum l4c_ps_map_ddm_src_id_to_l4c_src_id(ddm_source_id_enum ddm_src_id);

extern kal_bool l4c_ps_check_is_deact_aborting(kal_uint8 context_id);
extern void l4c_ps_assert();
...
extern void remove_mf_from_pathid(kal_uint8 *pathid_str);
...
void atci_print_at_debug_data(kal_uint8 *buffer, kal_uint16 length,kal_uint8 src_id, kal_uint8 URC);
kal_bool atci_l4b_urc_ind(kal_uint8 *cmd_str, kal_uint16 length, kal_bool stuff);
void atci_send_ilm_to_l4b(msg_type msg_id, local_para_struct *local_param_ptr, peer_buff_struct *peer_buf_ptr);
void atci_l4b_at_cmd_req_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
void atci_l4b_cmd_cnf(kal_uint8 src_id, kal_uint8 result, kal_uint8 *cmd_str, kal_uint16 length, kal_bool stuff);
void atci_l4b_result_code_fmttr(kal_uint8 src_id, kal_uint8 rsp_type, kal_uint8 *cmd_str, kal_uint16 length, kal_bool stuff);
kal_uint8 rmmi_available_cid_mapping(kal_uint32 cid);

extern void rmmi_send_call_status_to_scp(scp_call_type_enum cs_call_state);

#ifdef __ARFCN_TO_CAMERA_SUPPORT__
extern void rmmi_nw_camera_update_arfcn();
extern kal_bool rmmi_nw_arfcn_duplicate_check(rmmi_camera_arfcn_info_struct *arfcn_ptr);
#endif
