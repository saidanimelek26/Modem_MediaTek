...
extern void l4csmu_event_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void sim_card_type_switch_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4c_sim_extended_apdu_access_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

#ifdef __EUICC_SUPPORT__
extern void l4c_sim_apdu_res_block_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
#endif
...
extern void sim_rsa_sim_plug_out_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
extern void sim_rsa_sim_plug_in_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
extern void sim_card_type_change_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void sim_ct3g_inserted_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
extern void l4csmu_uicc_unlock_code_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4csmu_sml_get_lock_codes_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
extern void l4csmu_set_custom_personalization_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
#endif
extern void l4csmu_iccid_ready_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
