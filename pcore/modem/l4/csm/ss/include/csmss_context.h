...
typedef struct csmss_context_struct
{
    ...
    csmss_cfu_file_read_status_enum is_cfu_read;//bit mask, the current CFU read status
    kal_uint8 cfu_flag;
    kal_uint8 pending_cfu_flag;
    kal_uint8 pending_cfu_line;
    kal_uint8 cfu_file_access_id;//for solving multiple SAT file change collision
    kal_bool is_camp_on;
    kal_bool is_csm_start_req;
    kal_uint16 cfu_flag_len;//CPHS EF_CFF file length
