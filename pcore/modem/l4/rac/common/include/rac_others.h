...
extern void rac_send_plmn_list_cnf(rac_plmn_list_struct *plmn_list, l4c_rac_response_enum response, mm_cause_enum cause, kal_uint8 num_of_hplmn, freq_scan_output_struct *fs_output);
/* } mtk01778, 2007/07/31 */
...
extern kal_uint32 rac_covert_plmn_id_to_u32(plmn_id_struct *plmn_id);
extern kal_bool rac_is_peer_ps_c2k_rat_existed(kal_uint8 sim_interface);
...
extern rac_action_enum rac_get_action(protocol_id_enum protocol_id);
...
extern void rac_append_service_domain(domain_id_enum* current_domain, domain_id_enum new_requested_service);
extern void rac_remove_service_domain(domain_id_enum* current_domain, domain_id_enum domain_to_be_removed);
...
extern void rac_plmn_search_guard_timer_timeout_hdlr(void);
...
/*****************************************************************************
 * FUNCTION
 *  rac_get_internal_em_source
 *
 * DESCRIPTION
 *  Used to convert em_source to rac_internal_em_source
 *
 * PARAMETERS
 ...
 *
 *****************************************************************************/
rac_em_source_enum rac_get_internal_em_source(em_source_enum em_src);
 ...
 *
 * DESCRIPTION
 *  Used to send out constructed EM MSG
 *
 * PARAMETERS
 *  msg_type msg_id
 *  rac_em_source_enum target
 *  local_para_struct *local_para_ptr
 *
 * RETURNS
 *  none
 ...
 *
 *****************************************************************************/
void rac_send_out_em_msg(msg_type msg_id, rac_em_source_enum target, local_para_struct *local_para_ptr);
 ...
 *
 *****************************************************************************/
void rac_send_em_info();

/*****************************************************************************
 * FUNCTION
 *  rac_send_em_network_type
 *
 * DESCRIPTION
 *  send specific EM: rac_em_network_type
 *
 * PARAMETERS
 *  none
 *
...
*  rac_get_chr_em_info
* DESCRIPTION
*  Used to fill CHR related EM info
*
* PARAMETERS
...
*  none
*****************************************************************************/
void rac_get_chr_em_info(em_rac_info_ind_struct *em_msg_ptr);
...
void rac_nw_loss_opt_timer_timeout_hdlr(void);

/*****************************************************************************
 * FUNCTION
 *   rac_send_rat_disable_config_req
 *
 * DESCRIPTION
 *  Trigger from
 *  1. AT+EDRATCFG = [RAT]
 *  2. RAC preference nvram read cnf
 *  This function will send ilm with disable rat to gmss.
 *
 * PARAMETERS
 ...
 *
 *****************************************************************************/
 void rac_send_rat_disable_config_req(rat_enum disable_rat);
...
*  rac_send_nw_feature
* DESCRIPTION
*  update nw feature according to current nw feature status
*
* PARAMETERS
*  none
*
...
*  none
*****************************************************************************/
extern void rac_send_nw_feature();

/*****************************************************************************
 * FUNCTION
 *  rac_save_provision_record
 *
 * DESCRIPTION
 *  RAC will call this funcion to save provision sms_over_ip to NVRAM_EF_RAC_PROVISION_PROFILE_RECORD_LID according to SIM SBP id
 *
 * PARAMETERS
 *  rac_provision_para_enum para
 *
 * RETURNS
 *  void
 *
 ...
 *
 *****************************************************************************/
extern void rac_save_provision_record(rac_provision_para_enum);
 ...
 *
 * DESCRIPTION
 *  check whether parmeter got provision or not 
 *
 * PARAMETERS
 *  rac_provision_para_enum para
 *
 * RETURNS
 *  kal_bool
 *  KAL_TRUE: related para got provision before
 *  KAL_FALSE" related para did not got provision before
 *
 * GLOBALS AFFECTED
 *  none
 *
 *****************************************************************************/
extern kal_bool rac_check_provision(rac_provision_para_enum);

#endif /* _RAC_OTHERS_H */

/*****************************************************************************
* FUNCTION
*  rac_atomic_update_nvram_rat_mode
* DESCRIPTION
*  This function will update current rat mode of protocol stack to NVRAM
*
* PARAMETERS
*  rat_num rat_mode
*
* RETURNS
*  kal_bool    KAL_TRUE   update success
               KAL_FALSE  update fail
* GLOBALS AFFECTED
*  none
*****************************************************************************/
kal_bool rac_atomic_update_nvram_rat_mode(rat_enum nvram_rat_mode);
