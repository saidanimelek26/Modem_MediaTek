...
BEGIN_TRACE_MAP(MOD_PHB)
   ...
   TRC_MSG(INFO_PHB_STARTUP_STATE, "[PHB] startup state %d")
   TRC_MSG(INFO_PHB_STARTUP_RESET_ALL_CB, "[PHB] Reset all CB in startup state %d")
   TRC_MSG(INFO_PHB_SFI_VALUE, "[PHB] get_file_path: sfi = %d file id = %d")
   TRC_MSG(PHB_TRC_GET_CDMA_INFO, "[PHB] CDMA_phb_get_info: %Msim_file_index_enum")
   TRC_MSG(PHB_TRC_UIM_SST_QUERY_SUPPORTED, "[PHB] CDMA SST SUPPORTED service_id: %d")
   TRC_MSG(PHB_TRC_UIM_SST_QUERY_NOT_SUPPORTED, "[PHB] CDMA SST NOT SUPPORTED service_id: %d ret: %d service_state: %d")
   TRC_MSG(PHB_TRC_CDMA_CARD, "CDMA card inserted")
   TRC_MSG(PHB_TRC_CDMA_CSIM, "CDMA this is CSIM card")
   TRC_MSG(FUNC_PHB_SEND_CDMA_ILM, "[PHB] CDMA phb_send_cdma_ilm")
   TRC_MSG(INFO_PHB_STARTUP_CDMA_MODE, "[PHB] Startup CDMA dialing mode: %02X ret: %d")
   TRC_MSG(PHB_TRC_GMSS_CDMA_2000_SUPPORTED, "CDMA card GMSS CDMA2000 Supported")
   TRC_MSG(INFO_PHB_WAIT_UIM_STARTUP, "[PHB] CDMA waiting for UIM STARTUP")
   TRC_MSG(INFO_PHB_CDMA_STARTUP_STATE, "[PHB] CDMA startup state %d")
   TRC_MSG(INFO_PHB_CDMA_NOT_RESET, "[PHB] CDMA PHB not reset")
   TRC_MSG(INFO_PHB_SIM_ECC_RESET, "[PHB] SIM ECC reset")
   TRC_MSG(INFO_PHB_NW_ECC_RESET, "[PHB] NW ECC reset")
   TRC_MSG(INFO_PHB_SWAP_NW_ECC_LIST, "[PHB] NW ECC list swap due to sim switch")
   TRC_MSG(INFO_PHB_SIM_SWITCH, "[PHB] SIM SWITCH triggered")
   TRC_MSG(INFO_PHB_WRONG_CAUSE_IN_SIM_ERROR, "[PHB] Wrong Cause in SIM error ind")
   TRC_MSG(INFO_PHB_ABORT_DATA, "[PHB] DSS: phb_abort_data CB: %d is_allocated: %d cnf_msg_id: %d")
   TRC_MSG(INFO_PHB_ABORT_STARTUP_CNF, "[PHB] DSS: abort startup_cnf CB: %d query_count %d") 
   TRC_MSG(INFO_PHB_DSS_STARTUP_CNF, "[PHB] DSS: startup_cnf CB ID: %d res_msg_id: %d mod %d") 
   TRC_MSG(INFO_PHB_DSS_INFO, "[PHB] DSS: INFO phb_ptr->state: %d phb_current_mod: %d") 
   TRC_MSG(INFO_PHB_DSS_RECONFIG_REQ, "[PHB] DSS: ME RECONFIG REQ phb_current_mod: %d") 
   TRC_MSG(INFO_PHB_DSS_TSTS_INIT_PS, "[PHB] DSS: TSTS_support initial mapped protocol sim_switch_ps[%d]: %d bootup_sim[%d]: %d")
   TRC_MSG(INFO_PHB_DSS_TSTS_RECONFIG_HNDLR, "[PHB] DSS: TSTS_support reconfig hndlr: old[%d]: %d	sim_switch_ps[%d]: %d")
   TRC_MSG(INFO_PHB_DSS_TSTS_ABORT_CONTEXT, "[PHB] DSS: TSTS_support Abort on-going procedure for PHB context: %d")
   TRC_MSG(INFO_PHB_DSS_TSTS_SWAP_CONTEXT, "[PHB] DSS: TSTS_support context swap between old[%d]: %d and sim_switch_ps[%d]: %d")
   TRC_MSG(ERROR_PHB_ABNORMAL_DSS_TSTS, "[PHB] DSS: TSTS_support ABNORMAL CASE: Swap operation aborted as index INVALID!")
   TRC_MSG(INFO_PHB_DSS_TSTS_FIND_PS_INDEX, "[PHB] DSS: TSTS_support value of sim_switch_ps[%d] matches at position index %d of old protocol array")
   TRC_MSG(INFO_PHB_DSS_TSTS_FREE_BUFFER, "[PHB] DSS: TSTS_support free buffer ps: %d")
   TRC_MSG(ERROR_PHB_ABNORMAL_CASE1_DSS_TSTS, "[PHB] DSS: TSTS_support ABNORMAL CASE: Bootup PS value failure")
   TRC_MSG(ERROR_PHB_ABNORMAL_CASE2_DSS_TSTS, "[PHB] DSS: TSTS_support ABNORMAL CASE: Bootup PS none match")
   TRC_MSG(INFO_PHB_DSS_TSTS_MAP_SIM, "[PHB] DSS: TSTS_support phb_map_sim input sim %d output sim %d")
   TRC_MSG(INFO_PHB_SIM_SWITCH_POWEROFF_BY_L4, "[PHB] DSS: TSTS SIM ERROR IND POWEROFF_BY_L4 is_dss_no_reset %d sim_slot_id %d")
   TRC_MSG(INFO_PHB_TRY_CSIM_FDN, "[PHB] try CSIM FDN:  %Msim_file_index_enum, USIM fdn:%d, enable:%d, CSIM fdn:%d, enable:%d")
