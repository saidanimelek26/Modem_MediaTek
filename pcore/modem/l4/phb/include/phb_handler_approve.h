...
//#error "stack_ltlcom.h should be included"
    ...
    extern void phb_update_nw_ecc_list_handler(ilm_struct *ilm_ptr, control_block_type *control_block);
    extern void phb_sim_error_ind_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
#ifdef __cplusplus
}
#endif 
