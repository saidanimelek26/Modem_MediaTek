...
typedef enum
{
    PHB_STATE_NOT_IN_STARTUP,                 /* NULL state */
    PHB_STATE_FIRST_L4C_STARTUP,         /* PHB and LN both not ready */
    PHB_STATE_FIRST_UIM_STARTUP 
} phb_startup_state_enum;
#endif
typedef struct
{
...
typedef struct
{
   ...
   kal_bool 	is_cdma2000_supported;
	#ifdef __CDMA2000_RAT__
	  phb_startup_state_enum      startup_state;
	#endif
} phb_context_type;
