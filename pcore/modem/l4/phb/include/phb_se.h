...
#error "phb_control_block.h should be included"
    ...
    extern void phb_se_new(kal_uint8 instance);
    ...
    extern void phb_se_delete(phb_type_enum type, kal_uint16 old_index, kal_uint8 *ext_index, kal_uint8 storage);
    ...
    extern void phb_se_set_usim_control_block(
                        control_block_type *control_block,
                        phb_storage_enum storage,
                        kal_uint16 record_index,
...
/* under construction !*/
    ...
    extern void phb_se_set_ln_control_block(control_block_type* control_block, kal_uint16 record_index);
#endif /* __PHB_ACCESS_SIM_LN__ */
#ifdef __cplusplus
}
#endif 

extern kal_uint8 phb_se_get_ext_index(kal_uint16 parent_id, kal_uint8 occurrence, kal_uint16 sort_index, kal_uint16 record_index);
extern void phb_se_set_ext_index(kal_uint16 parent_id, kal_uint8 occurrence, kal_uint16 record_index, kal_uint16 ext_index);
extern void phb_se_delete_ext_index(kal_uint16 file_id, kal_uint16 ext_index);
