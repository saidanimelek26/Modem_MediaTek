...
@interface_header = ("./pcore/interface/hal/video/video_memory_usage_v2.h", "./pcore/interface/hal/video/media_provider_mem_usage.h", "./pcore/interface/hal/video/media_session_mem_usage.h");
...
open(AUTO_GEN_HEADER, ">./pcore/interface/hal/video/video_mem_gen.h") || die "file open fail!\n";
