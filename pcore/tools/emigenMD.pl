...
#* smart new env.
#*
#* 06 04 2015 guo-huei.chang
#* [MOLY00118588] update emigen for SP projrect
#* update emigen for SP project with common MDL
#*
...
#*
#* 03 31 2014 way.chen
#* [MOLY00061385] [TK6291][UMOLY] Update EMIGEN Flash Part Code
#* Update EMIGEN code for TK6291 chips
#*
...
require "pcore/tools/emigenemi.pl";
require "pcore/tools/emigenflash.pl";
require "pcore/tools/emigenSF.pl";
...
{
    &Check_ManualCheckIn($CUSTOM_EMI_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($CUSTOM_EMI_RELEASE_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($CUSTOM_EMI_INFO_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($CUSTOM_SFI_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigen_flash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($CUSTOM_FLASH_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($FLASH_OPT_GEN_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($CUSTOM_FLASH_NORFDM5_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($COMBO_FLASH_CONFIG_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($COMBO_FLASH_ID_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($COMBO_SFI_CONFIG_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    &Check_ManualCheckIn($COMBO_SFI_DEFS_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
    exit;
}

#****************************************************************************
# generate emigen dependency file
#****************************************************************************
if ($TARGET_DET)
{
     print "TARGET_DET: $TARGET_DET\n";
     unlink $TARGET_DET if (-e $TARGET_DET);
     &PrintDependModule();
     &PrintDependModule($MEMORY_DEVICE_LIST_XLS or $MEMORY_DEVICE_LIST_INT_XLS);
     &PrintToDep("$TARGET_DET");
}
...
# dependency check
#****************************************************************************
&Check_ManualCheckIn($CUSTOM_EMI_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($CUSTOM_EMI_RELEASE_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($CUSTOM_EMI_INFO_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($CUSTOM_SFI_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigen_flash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($CUSTOM_FLASH_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($FLASH_OPT_GEN_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($CUSTOM_FLASH_NORFDM5_H, "TRUE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($COMBO_FLASH_CONFIG_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($COMBO_FLASH_ID_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($COMBO_SFI_CONFIG_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($COMBO_SFI_DEFS_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($CUSTOM_SFI_CLOCK_DEFS_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
&Check_ManualCheckIn($COMBO_NFI_CONFIG_H, "FALSE", "pcore/tools/emiGenMD.pl", "pcore/tools/emiGenSP.pl", "pcore/tools/emigenemi.pl", "pcore/tools/emigenflash.pl", "pcore/tools/emigenSF.pl", $THEMF, $CUSTOM_MEMORY_DEVICE_HDR, $MEMORY_DEVICE_LIST_XLS, $MEMORY_DEVICE_LIST_INT_XLS, $CUSTOM_FEATURE_CONFIG_HDR);
...
{
    require "pcore/tools/emiGenSP.pl";
    $emi_is_existed = 0;
}
...
sub Find_MDL
{
    my $MDL_DIR = "pcore/tools/MemoryDeviceList/";
...
sub fs_read_excel
{
    ...
    if($file =~ /^(\w+.*?)\.xls$/)
    {
        ...
        {
            print "1:$1,2:$2,3:$3\n";
            $copied_file = $BACKUP_MDL_PATH . "\/". "MemoryDeviceList_" . $3;
        }
    }
...
sub description_file_header
{
    ...
    } elsif (-e "pcore/tools/emiGenSP.pl") {
        @stat_ar = stat "pcore/tools/emiGenSP.pl";
        ($sec, $min, $hour, $day, $month, $year) = localtime($stat_ar[9]);
    } else {
