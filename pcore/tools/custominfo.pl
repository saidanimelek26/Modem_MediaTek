...
if (defined $touch_panel_shortcut_support) {
  if ($touch_panel_shortcut_support eq "TRUE") {
    copy("pcore/custom/common/touch_panel_shortcut_custom.c.tmp", "pcore/custom/app/$board_ver/touch_panel_shortcut_custom.c");
    copy("pcore/custom/common/touch_panel_shortcut_custom.h.tmp", "pcore/custom/app/$board_ver/touch_panel_shortcut_custom.h");
  }
}
...
if (($project ne "basic") && ($project ne "l1s") && defined($j2me_support)) {
  if ($j2me_support ne "NONE") {
    ...
    if (!-e "pcore/custom/j2me/$j2meFolder/$j2me_boardBB/j2me_custom_option.h") {
      if (-e "pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/_j2me_custom_option.h") {
        copy("pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/_j2me_custom_option.h", "pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/j2me_custom_option.h");
      }
    } else {
    	if (-e "pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/j2me_custom_option.h") {
      	unlink("pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/j2me_custom_option.h");
      }
    }

    if (!-e "pcore/custom/j2me/$j2meFolder/$j2me_boardBB/j2me_custom_param.h") {
      if (-e "pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/_j2me_custom_param.h") {
        copy("pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/_j2me_custom_param.h", "pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/j2me_custom_param.h");
      }
    } else {
      if (-e "pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/j2me_custom_param.h") {
      	unlink("pcore/custom/j2me/$j2meFolder/_DEFAULT_BB/j2me_custom_param.h");
      }
    }
  }
}
