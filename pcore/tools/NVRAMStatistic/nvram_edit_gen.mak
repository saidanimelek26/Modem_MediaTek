...
ifeq ($(strip $(OS_VERSION)),MSWin32)
  ...
  def_h := $(foreach DIR, $(nvram_dir_list), $(subst ${CORE_ROOT}/custom/$(DIR)/,,$(wildcard ${CORE_ROOT}/custom/$(DIR)/*_nvram_def.h)))

  editor_h := $(foreach DIR, $(nvram_dir_list), $(subst ${CORE_ROOT}/custom/$(DIR)/,,$(wildcard ${CORE_ROOT}/custom/$(DIR)/*_nvram_editor.h)))

  def_c := $(foreach DIR, $(nvram_dir_list), $(wildcard ${CORE_ROOT}/custom/$(DIR)/*_nvram_def.c))
