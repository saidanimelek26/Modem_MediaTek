...
#* $Log$
#*
#* 09 05 2016 chi-chun.lu
#* [MOLY00200780] [MakeFile] [UMOLY] [Modify Makefile Rules]fix smart new false alarm of sysgen
#* 	
#* 	.
#*
#* 09 02 2016 chi-chun.lu
#* [MOLY00200780] [MakeFile] [UMOLY] [Modify Makefile Rules]fix smart new false alarm of sysgen
#* 	
#* 	(rollback).
#*
...
#****************************************************************************
my ($input_folder, $output_folder, $smart_new) = @ARGV;
...
# Main Flow
#****************************************************************************
rmtree("$output_folder/Template") if(-d "$output_folder/Template");
if ($smart_new ne "TRUE") {
