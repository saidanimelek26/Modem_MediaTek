...
typedef struct {
    ...
    kal_uint8 src_id;
    uicc_app_type_enum app_type;
} sim_card_type_switch_req_struct, gmss_sim_card_type_switch_req_struct;

typedef struct {
    LOCAL_PARA_HDR
    kal_uint8 src_id;
    kal_bool result;
} sim_card_type_switch_cnf_struct, gmss_sim_card_type_switch_cnf_struct;
#endif
...
typedef struct {
    LOCAL_PARA_HDR
    kal_bool is_cdma;
} gmss_sim_cs_stk_domain_ind_struct;
...
/*MSG_ID_SIM_CARD_TYPE_CHANGE_IND*/
typedef struct {
    LOCAL_PARA_HDR
    uicc_app_type_enum app_type;
    sim_ct3g_switch_src_enum ct3g_switch_src;
} sim_card_type_change_ind_struct;
