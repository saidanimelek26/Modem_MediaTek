...
typedef enum
{
   ...
   CSMCC_CATEGORY_KOREA_REPORTING_SPIES = 3, /*only for korea operator*/
   CSMCC_CATEGORY_FIRE_BRIGADE = 4,
   CSMCC_CATEGORY_KOREA_INTELLIGENCE_SERVICE = 6, /*only for korea operator*/
   CSMCC_CATEGORY_MARINE_GUARD = 8,
   CSMCC_CATEGORY_KOREA_CUSTOMS_SERVICE = 9, /*only for korea operator*/
   CSMCC_CATEGORY_MOUNTAIN_RESCUE = 16,
   CSMCC_CATEGORY_KOREA_SCHOOL_VIOLENCE = 18, /*only for korea operator*/
   CSMCC_CATEGORY_KOREA_CYBER_TERRORISM = 19, /*only for korea operator*/
