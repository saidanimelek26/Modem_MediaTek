...
#ifdef __REL6__
kal_bool l4ctcm_encode_bit_rate(kal_uint32 rate, kal_uint32 *val_ptr);
#else // #ifdef __REL6__
kal_bool l4ctcm_encode_bit_rate(kal_uint16 rate, kal_uint16 *val_ptr);
#endif // ~ #ifdef __REL6__

#ifdef __REL6__
kal_bool l4ctcm_decode_bit_rate(kal_uint32 val, kal_uint32 *rate_ptr);
kal_bool l4ctcm_decode_apn_ambr_bit_rate(kal_uint8 val, kal_uint8 val_ext, kal_uint8 val_ext2, kal_uint32 *rate_ptr);
#else // #ifdef __REL6__
