 ...
 * Integrated mcu/pcore changes from 2124898 to 2168172.
 *
 * 08 03 2015 david.tang
 * [MOLY00135036] [MT6291][E1EVB][EL1S] Update l1edps files from CBrV6
 * .[l1edps] update header files
 *
 * Original content from SCH_TRX_CA_01.h - changed EARFCNs
 ****************************************************************************/

#ifndef _L1SS_2DL2UL_FDD_BASIC_07_H
#define _L1SS_2DL2UL_FDD_BASIC_07_H
...
#undef RRC_SETUP_N_PUSCH_ID_BTS1
#undef RRC_SETUP_N_DMRS_CSH_ID_BTS1


/*radioResourceConfigCommon.uplinkPowerControlCommon.p0-NominalPUSCH*/
#undef SIB2_P0_NOMINAL_PUSCH_BTS2
#undef SIB2_P0_NOMINAL_PUCCH_BTS2
#undef SIB2_DELTA_PUCCH_FORMAT1_deltaF_BTS2
#undef SIB2_DELTA_PUCCH_FORMAT1B_deltaF_BTS2
#undef SIB2_DELTA_PUCCH_FORMAT2_deltaF_BTS2
#undef SIB2_DELTA_PUCCH_FORMAT2A_deltaF_BTS2
#undef SIB2_DELTA_PUCCH_FORMAT2B_deltaF_BTS2
...
#define RRC_SETUP_N_PUSCH_ID_BTS1               0          /*0..509,0xFFFF*/
#define RRC_SETUP_N_DMRS_CSH_ID_BTS1            0          /*0..509,0xFFFF*/

#define SIB2_P0_NOMINAL_PUSCH_BTS2 -90						/*-126..24*/
