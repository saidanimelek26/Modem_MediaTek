...
usage: perl ./common/tools/MemoryUtility/ListTopSizeObj.pl lis/map_file_path

e.g. ./common/tools/MemoryUtility/ListTopSizeObj.pl ./build/ELBRUS_FPGA/BASIC/bin/ELBRUS_FPGA_PCB01_P_ELBRUS_FPGAS00.map
