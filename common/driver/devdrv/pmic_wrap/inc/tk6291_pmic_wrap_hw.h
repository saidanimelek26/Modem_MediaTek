 ...
 * Description:
 * ------------
 *	This is tk6291 pmic wrapper h/w register
 *
 * Author:
 * -------
 * -------
...
#ifndef __TK6291_PMIC_WRAP_HW_H__
#define __TK6291_PMIC_WRAP_HW_H__
...
*/
#define PMIC_WRAP_BASE					    (BASE_MADDR_PMIC_BSI)
#else                                       
#define PMIC_WRAP_BASE					    (0xC3590000)
...
#define PMIC_WRAP_SPMINF_STA                (PMIC_WRAP_BASE+0x18C)
#define PMIC_WRAP_CIPHER_KEY_SEL            (PMIC_WRAP_BASE+0x190)
#define PMIC_WRAP_CIPHER_IV_SEL             (PMIC_WRAP_BASE+0x194)
#define PMIC_WRAP_CIPHER_EN                 (PMIC_WRAP_BASE+0x198)
#define PMIC_WRAP_CIPHER_RDY                (PMIC_WRAP_BASE+0x19C)
#define PMIC_WRAP_CIPHER_MODE               (PMIC_WRAP_BASE+0x1A0)
#define PMIC_WRAP_CIPHER_SWRST              (PMIC_WRAP_BASE+0x1A4)
#define PMIC_WRAP_DCM_EN                    (PMIC_WRAP_BASE+0x1A8)
#define PMIC_WRAP_DCM_DBC_PRD               (PMIC_WRAP_BASE+0x1AC)
#define PMIC_WRAP_EXT_CK                    (PMIC_WRAP_BASE+0x1B0)
#define PMIC_WRAP_ADC_CMD_ADDR              (PMIC_WRAP_BASE+0x1B4)
#define PMIC_WRAP_PWRAP_ADC_CMD             (PMIC_WRAP_BASE+0x1B8)
#define PMIC_WRAP_ADC_RDATA_ADDR            (PMIC_WRAP_BASE+0x1BC)
#define PMIC_WRAP_GPS_STA                   (PMIC_WRAP_BASE+0x1C0)
#define PMIC_WRAP_SWRST                     (PMIC_WRAP_BASE+0x1C4)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR_LATEST  (PMIC_WRAP_BASE+0x1C8)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR_WP      (PMIC_WRAP_BASE+0x1CC)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR0        (PMIC_WRAP_BASE+0x1D0)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR1        (PMIC_WRAP_BASE+0x1D4)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR2        (PMIC_WRAP_BASE+0x1D8)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR3        (PMIC_WRAP_BASE+0x1DC)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR4        (PMIC_WRAP_BASE+0x1E0)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR5        (PMIC_WRAP_BASE+0x1E4)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR6        (PMIC_WRAP_BASE+0x1E8)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR7        (PMIC_WRAP_BASE+0x1EC)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR8        (PMIC_WRAP_BASE+0x1F0)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR9        (PMIC_WRAP_BASE+0x1F4)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR10       (PMIC_WRAP_BASE+0x1F8)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR11       (PMIC_WRAP_BASE+0x1FC)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR12       (PMIC_WRAP_BASE+0x200)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR13       (PMIC_WRAP_BASE+0x204)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR14       (PMIC_WRAP_BASE+0x208)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR15       (PMIC_WRAP_BASE+0x20C)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR16       (PMIC_WRAP_BASE+0x210)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR17       (PMIC_WRAP_BASE+0x214)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR18       (PMIC_WRAP_BASE+0x218)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR19       (PMIC_WRAP_BASE+0x21C)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR20       (PMIC_WRAP_BASE+0x220)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR21       (PMIC_WRAP_BASE+0x224)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR22       (PMIC_WRAP_BASE+0x228)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR23       (PMIC_WRAP_BASE+0x22C)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR24       (PMIC_WRAP_BASE+0x230)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR25       (PMIC_WRAP_BASE+0x234)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR26       (PMIC_WRAP_BASE+0x238)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR27       (PMIC_WRAP_BASE+0x23C)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR28       (PMIC_WRAP_BASE+0x240)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR29       (PMIC_WRAP_BASE+0x244)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR30       (PMIC_WRAP_BASE+0x248)
#define PMIC_WRAP_MD_ADC_RDATA_ADDR31       (PMIC_WRAP_BASE+0x24C)
#define PMIC_WRAP_MD_ADC_MODE_SEL           (PMIC_WRAP_BASE+0x250)
#define PMIC_WRAP_MD_ADC_STA0               (PMIC_WRAP_BASE+0x254)
#define PMIC_WRAP_MD_ADC_STA1               (PMIC_WRAP_BASE+0x258)
...
#define GET_AG_HARB_REQ(x)                  ((x>>15) & 0x000007ff)
#define GET_HARB_WRAP_W(x)                  ((x>>26) & 0x00000001)
#define GET_HARB_WRAP_REQ0(x)               ((x>>27) & 0x00000001)
...
#define HARB_HPRIO_ALL          0x7FF
/*
[10]: WACSP2P (SCP SW) (RESERVED)
[9]: WACS3 (C2K SW)
[8]: WACS1 (MD SW1)
[7]: GPSINF (RESERVED)
[6]: STAUPD
[5]: WACS2 (AP SW)
[4]: MD_ADCINF (Co-clock)
[3]: DVFSINF (SPMINF) (RESERVED)
[2]: WACS0 (MD SW0)
[1]: C2kINF (RESERVED)
[0]: MDINF
*/
#define HARB_HPRIO_WACSP2P      (1 << 10) // (RESERVED)
#define HARB_HPRIO_WACS3        (1 << 9)
#define HARB_HPRIO_WACS1        (1 << 8)
#define HARB_HPRIO_GPSINF       (1 << 7)
#define HARB_HPRIO_STAUPD       (1 << 6)
#define HARB_HPRIO_WACS2        (1 << 5)
#define HARB_HPRIO_MD_ADCINF	(1 << 4)
#define HARB_HPRIO_DVFSINF      (1 << 3) // (RESERVED)
#define HARB_HPRIO_WACS0        (1 << 2)
#define HARB_HPRIO_C2KINF       (1 << 1) // (RESERVED)
...
#define OP_ODNID (0x1A)
 ...
 #endif // __TK6291_PMIC_WRAP_HW_H__                   
