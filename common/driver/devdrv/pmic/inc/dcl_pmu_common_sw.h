...
#define PMIC_ACCESS_DURATION_THRESHOLD			40
...
typedef enum
{
    PMIC_LOG_TYPE_NORMAL_DOMAIN = 0,
    PMIC_LOG_TYPE_HRT_DOMAIN = 1,
    PMIC_LOG_TYPE_MAX
}PMIC_LOG_TYPE_ENUM;

extern PMIC_ACCESS_DURATION_DBG pmic_access_duration_log[PMIC_LOG_TYPE_MAX][PMIC_DURATION_LOG_MAX][MAX_PMIC_DURATION_INFO_SIZE];
extern DCL_UINT32 pmic_access_duration_index [PMIC_LOG_TYPE_MAX] ;
extern DCL_UINT32 pmic_access_timing_issue_log [PMIC_LOG_TYPE_MAX][MAX_PMIC_DURATION_INFO_SIZE];
extern DCL_UINT32 pmic_access_timing_issue_index [PMIC_LOG_TYPE_MAX];
