...
BEGIN_TRACE_MAP(MOD_L1SP)
   ...
   TRC_MSG(DACA_LEAVE_GETDATA,                   "[DataCard]##Leave GetData")   
	...
	TRC_MSG(SPC_SPEECH_ON_PAYLOAD,     "Spc_Speech_On, app:%d, bt:%d, sr:%d, openDsp:%d, paramPath:%d, shmValid:%d, paramSize:%d, idx:%d, devInfo:%d, muteMask=%x")
   ...
   TRC_MSG(L1SP_SPE_CTRL_UPDATE, "L1SP Set Enhancement ctrol update,ENH ctrl=0x%x, notch filter=0x%x, Network info=0x%x")
