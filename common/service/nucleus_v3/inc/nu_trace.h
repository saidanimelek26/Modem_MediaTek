...
#define TRACE_HW_TIMER_TICKS_PER_SEC    (ESAL_GE_TMR_OS_CLOCK_RATE / ESAL_GE_TMR_OS_CLOCK_PRESCALE)

/* Define the number of hardware timer ticks that occur for each Nucleus PLUS
   software tick */
#define TRACE_HW_TIMER_TICKS_PER_SW_TICK (TRACE_HW_TIMER_TICKS_PER_SEC / NU_PLUS_TICKS_PER_SEC)
#define FREQ_1GHZ                       1000000000
#define MESA_TIME_BASE                  FREQ_1GHZ
#define SCALE_FACTOR_1GHZ               (MESA_TIME_BASE/(TRACE_HW_TIMER_TICKS_PER_SW_TICK * NU_PLUS_TICKS_PER_SEC))
...
#define NU_TRACE_SMP_INFO               (1<<0X11)
...
#define NU_TRACE_TX_IN_PROGRESS         (NU_TRACE_KERN_NOT_AVAILABLE - 1)
#define NU_TRACE_ERROR_CODE_DELIMITER   (NU_TRACE_TX_IN_PROGRESS - 1)

#ifdef CFG_NU_OS_SVCS_TRACE_CORE_ENABLE
...
#endif /* CFG_NU_OS_SVCS_TRACE_CORE_ENABLE */
