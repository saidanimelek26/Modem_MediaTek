 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_1909_P1, "Exception happened when PC was at DSM section, please check DSM related infomation")
   TRC_MSG(SST_PHASE1_1909_P2, "to see if correct DSM section was loaded when exception happened")

   TRC_MSG(SST_PHASE1_1909_P3, "Here is info about the exception:")
