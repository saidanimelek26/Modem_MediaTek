 ...
 *******************************************************************************/
extern kal_int32 mlib_dll_insert_at_start(list_node *head, list_node *new_node);
extern kal_int32 mlib_dll_insert_at_end(list_node *head, list_node *new_node);
extern list_node * mlib_dll_delete(list_node *head, list_node *del_node);
