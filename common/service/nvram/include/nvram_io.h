...
extern nvram_errno_enum nvram_read_exception_data_item(
                            nvram_ltable_entry_struct *ldi,
...
extern nvram_errno_enum nvram_read_data_item_chksum(
                            ...
                            kal_bool verify);
extern nvram_errno_enum nvram_read_data_item_chksum_8b(
                            nvram_ltable_entry_struct *ldi,
                            kal_uint16 rec_index,
                            kal_uint16 rec_amount,
                            kal_uint8 *chksum,
...
extern nvram_errno_enum nvram_write_exception_data_item(
                            nvram_ltable_entry_struct *ldi,
                            kal_uint16 index,
                            kal_uint8 *data);
