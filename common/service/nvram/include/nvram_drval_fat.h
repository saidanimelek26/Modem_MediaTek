...
#define NVRAM_FS_CUST_DATAITEM_PATH          "Z:\\NVRAM\\NVD_CUST"
  ...
  #endif
#define NVRAM_FS_OTA_DATAITEM_PATH          "Z:\\NVRAM\\BACKUP"  
#endif
...
#define NVRAM_TEST_FS_ROOT_PATH                   "Z:\\NV_TEST"
#define NVRAM_TEST_FS_DATAITEM_PATH               "Z:\\NV_TEST\\NVD_DATA"
#define NVRAM_TEST_SWCHANGE_REPORT_FILE           "Z:\\NV_TEST\\SWCHANGE"
#define NVRAM_TEST_SWCHANGE_REPORT_FILE_TXT       "Z:\\NV_TEST\\SWCHANGE.TXT"
#ifdef __NVRAM_MULTI_FOLDERS__
...
typedef enum
{
    ...
    NVRAM_DRV_READ_TYPE_CHKSUM_ONLY,
    NVRAM_DRV_READ_TYPE_CHKSUM_8B,
    NVRAM_DRV_READ_TYPE_CHKSUM_ONLY_8B,
    NVRAM_DRV_READ_TYPE_MAX
}nvram_drv_read_type_enum;

#if defined (__NVRAM_UT_TEST__)

#define NVRAM_FS_MAKE_ROOT_PATH(buf)  if((is_insulation_access) && (nvram_test_task1_id) && (kal_get_current_task()==nvram_test_task1_id))\
    kal_wsprintf( buf, "%s", NVRAM_TEST_FS_ROOT_PATH );\
    else \
...
extern nvram_drv_status_enum nvram_drv_fat_write_exception_item(
                                kal_uint8 *buffer,
                                kal_char *nvramname,
                                kal_uint16 section_number,
                                kal_uint32 size,
