...
/* under construction !*/
    ...
    /* stack place in ZI */
    do{
        extern kal_uint32  Image$$CACHED_EXTSRAM$$ZI$$Base;
        extern kal_uint32  Image$$CACHED_EXTSRAM$$ZI$$Length;
        extern kal_uint32  STACK_INIT$$ZI$$Length;
        void * ZI_base          = (void *) ((kal_uint32)&Image$$CACHED_EXTSRAM$$ZI$$Base + (kal_uint32)&STACK_INIT$$ZI$$Length);
        kal_uint32 ZI_length    = (kal_uint32) &Image$$CACHED_EXTSRAM$$ZI$$Length - (kal_uint32)&STACK_INIT$$ZI$$Length;
        if (0!=ZI_length)   kal_mem_set_init(ZI_base, 0, ZI_length);
    }while(0);
#endif
