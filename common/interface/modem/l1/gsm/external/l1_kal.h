...
extern INLINE ilm_struct* L1_ALLOC_CC_MSG(module_type ilm_id, kal_uint16 size, kal_uint32 direction)
{
   ilm_struct *ilm_ptr;
...
extern INLINE ilm_struct* L1_ALLOC_MSG(module_type mod_id, kal_uint32 size)
{
...

   {
      ...
      ilm_ptr->local_para_ptr->msg_len = (kal_uint16)size;
   }
   return ilm_ptr;
}
...
extern INLINE ilm_struct* L1_ALLOC_CC_MSG(module_type mod_id, kal_uint16 size, kal_uint32 direction)
{
