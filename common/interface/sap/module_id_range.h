...
typedef enum {
    MOD_ID_SRV_CODE_BEGIN, MOD_ID_SRV_CODE_TAIL = MOD_ID_SRV_CODE_BEGIN + 100,
	
    MOD_ID_MODEM_2G3G_CODE_BEGIN, MOD_ID_MODEM_2G3G_CODE_TAIL = MOD_ID_MODEM_2G3G_CODE_BEGIN + 530,

    MOD_ID_MODEM_4G_CODE_BEGIN, MOD_ID_MODEM_4G_CODE_TAIL = MOD_ID_MODEM_4G_CODE_BEGIN + 180,	
	
    MOD_ID_MIDDLEWARE_CODE_BEGIN, MOD_ID_MIDDLEWARE_CODE_TAIL = MOD_ID_MIDDLEWARE_CODE_BEGIN + 110,
	
    MOD_ID_DRV_CODE_BEGIN, MOD_ID_DRV_CODE_TAIL = MOD_ID_DRV_CODE_BEGIN + 100,  //tmp for add null task & print 40 + 50 

    MOD_ID_HISR_CODE_BEGIN, 
#if defined(__UNIFIED_ISR_LEVEL__)
    MOD_ID_HISR_CODE_TAIL = MOD_ID_HISR_CODE_BEGIN + 168 +1,
#else
    MOD_ID_HISR_CODE_TAIL = MOD_ID_HISR_CODE_BEGIN + 90 + 40 +1,  //follow MOD_APP_BEGIN = (MOD_HISR_BEGIN + KAL_MAX_NUM_HISRS + 1)
#endif	
