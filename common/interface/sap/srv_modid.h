...
#define task_duplicated_c0c1_module_map(task, mod)                  mod, mod##_CORE0, mod##_CORE1,
#define task_duplicated_c0c2_module_map(task, mod)                  mod, mod##_CORE0, mod##_CORE2,
#define task_duplicated_c0c3_module_map(task, mod)                  mod, mod##_CORE0, mod##_CORE3,
#define task_duplicated_c1c2_module_map(task, mod)                  mod, mod##_CORE1, mod##_CORE2,
#define task_duplicated_c1c3_module_map(task, mod)                  mod, mod##_CORE1, mod##_CORE3,
#define task_duplicated_c2c3_module_map(task, mod)                  mod, mod##_CORE2, mod##_CORE3,
#define task_duplicated_c0c1c2_module_map(task, mod)                mod, mod##_CORE0, mod##_CORE1, mod##_CORE2,
#define task_duplicated_c1c2c3_module_map(task, mod)                mod, mod##_CORE1, mod##_CORE2, mod##_CORE3,
#define task_duplicated_c0c1c2c3_module_map(task, mod)              mod, mod##_CORE0, mod##_CORE1, mod##_CORE2, mod##_CORE3,
