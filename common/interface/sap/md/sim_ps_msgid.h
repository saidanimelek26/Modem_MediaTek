...
MODULE_MSG_BEGIN( MSG_ID_SIM_PS_CODE_BEGIN )
   ...
   MSG_ID_SIM_CARD_TYPE_SWITCH_REQ,
   MSG_ID_SIM_CARD_TYPE_SWITCH_CNF,
   MSG_ID_SIM_CARD_TYPE_CHANGE_IND,
   MSG_ID_GMSS_SIM_CARD_TYPE_SWITCH_REQ,
   MSG_ID_GMSS_SIM_CARD_TYPE_SWITCH_CNF,
   MSG_ID_SAT_SET_RAT_MODE_REQ,
   MSG_ID_SAT_SET_RAT_MODE_CNF,
   MSG_ID_GMSS_SIM_CS_STK_DOMAIN_IND,
   ...
   MSG_ID_SIM_SUBMODULE_REREAD_REQ,
   ...
   MSG_ID_SAT_APN_CONNECTION_STATUS_IND,
