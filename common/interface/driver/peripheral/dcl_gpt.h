...
#else
/* ALTERA 6291 Version */
//#define LITEGPT_CLOCK 15625//15625
//#define LITEGPT_US_TO_TICK(us) ((us)/64)
/* HAPS  6291 Version */
#define LITEGPT_CLOCK 15960//15960
#define LITEGPT_US_TO_TICK(us) (((us)*2)/125)
#endif
...
#else
#define LITEGPT_CLOCK 16384
#define LITEGPT_US_TO_TICK(us) ((us)/61)
#endif
#endif
