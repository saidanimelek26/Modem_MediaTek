...
/**************** GPT Feature Option******************/
   ...
   #define DRV_GPT_LOGGING_TIMER        (5U)
   #define DRV_GPT_C2KOS_TIMER        (6U)
   #define DRV_GPT_C2KAR_TIMER        (7U)
   #define DRV_GPT_DSP_TIMER        (8U)
