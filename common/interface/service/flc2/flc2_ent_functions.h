...
typedef struct
{
    kal_uint16  front_guard;
    kal_uint16  alloc_size;
    kal_uint16  pool_id;
    kal_uint16  used_size;
} flc2_buf_header_struct;
...
#define flc2_get_max_grow_size(_pool_id_)  \
        flc2_ent_get_max_grow_size(_pool_id_)
...
#define flc2_mask_peer_buff_for_miniDump() flc2_ent_mask_peer_buff_for_miniDump()
...
extern kal_uint32 flc2_ent_get_max_grow_size(flc2_pool_id_enum pool_id);

extern kal_bool flc2_ent_check_peer_buff(flc2_pool_id_enum pool_id,
    peer_buff_struct *buff_ptr);

extern kal_bool flc2_ent_check_peer_buff_without_pool_id(
    peer_buff_struct *buff_ptr);

extern void flc2_check_all_guard_patterns(void *ptr);
...
extern void flc2_ent_mask_peer_buff_for_miniDump(void);
