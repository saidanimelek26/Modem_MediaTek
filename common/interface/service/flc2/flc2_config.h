...
#define FLC2_BEGIN_POOL_PROTECT(_pool_id_) { \
    if (_pool_id_ == FLC2_POOL_ID_HIF_UL_SPD) { \
        kal_take_enh_mutex(flc2_pool_hif_ul_spd_mutex); \
    } else { \
...
#define FLC2_END_POOL_PROTECT(_pool_id_) { \
    if (_pool_id_ == FLC2_POOL_ID_HIF_UL_SPD) { \
        kal_give_enh_mutex(flc2_pool_hif_ul_spd_mutex); \
    } else { \
...
typedef enum {
    ...
    FLC2_POOL_ID_C2K_BEGIN,
    FLC2_POOL_ID_C2K_FWD = FLC2_POOL_ID_C2K_BEGIN,  // For C2K Forward(downlink)data
    FLC2_POOL_ID_C2K_REV,                           // For C2K Reverse(uplink) data
    FLC2_POOL_ID_C2K_SIG,                           // For C2K OTA Message
    FLC2_POOL_ID_C2K_END = FLC2_POOL_ID_C2K_SIG,

    FLC2_POOL_ID_FOR_UT_ONLY,
    FLC2_POOL_ID_UT_BEGIN,
    FLC2_POOL_TOTAL = (FLC2_POOL_ID_UT_BEGIN + FLC2_MAX_UT_POOL_ID),

	FLC2_POOL_ID_HIF_UL_SPD,
...
typedef enum {
    ...
    FLC2_PROFILE_INDEX_C2K_FWD,
    FLC2_PROFILE_INDEX_C2K_REV,
    FLC2_PROFILE_INDEX_C2K_SIG,
...
typedef enum {
    ...
    FLC2_MB_INDEX_10,   /* for NPDU UL, PSPDU UL, Cipher (GPRS), C2K FWD&REV */
    ...
    FLC2_MB_C2K_SIG,    /* for C2K SIG pool */
...
extern void flc2_c2k_fwd_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_c2k_rev_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
#endif
...
#if defined (__C2K_RAT__)
#define flc2_ent_c2k_fwd_callback         flc2_c2k_fwd_callback
#define flc2_ent_c2k_rev_callback         flc2_c2k_rev_callback
#else
#define flc2_ent_c2k_fwd_callback         NULL
#define flc2_ent_c2k_rev_callback         NULL
#endif
...
extern kal_enhmutexid flc2_pool_hif_ul_spd_mutex;
