...
#define FLC2_NPDU_UL_CHUNKS         100
#else
...
#else // defined(__3G_NEW_DATA_PLANE_ARCH__)
...
// UMOLYA: Not used by QBM anymore. Adjust the size for Gen-93 data path later.
#define FLC2_NPDU_UL_CHUNK_SIZE    \
     (FLC2_MEM_SIZE_ALIGN_32(1704 + 32 + L3_UL_RESERVED_HEADER_SPACE + 64))
...
#define FLC2_NPDU_DL_CHUNK_SIZE	(1704 + 32)
...
// UMOLYA: QBM for 4G data path does not used FLC anymore. Adjust the size
// later.
/* UL2CC: 100 Mbps */
#define _FLC2_NPDU_UL_MAX_GROW  (FLC2_NPDU_UL_CHUNK_SIZE * 500)
#define _FLC2_NPDU_DL_MAX_GROW  (62 * 1024)

#elif defined(__FDD_MAC_EHS_SUPPORT__) /* Support latter than R7 */
...
#define _FLC2_NPDU_UL_MAX_GROW  0
...
#else // !defined(__UMTS_TDD128_MODE__) || defined(__3G_NEW_DATA_PLANE_ARCH__)
#if (defined(__HSUPA_SUPPORT__) && !defined(__HSUPA_CAPABILITY_NOT_SUPPORT__))
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
// UMOLYA: Not used by QBM anymore. Remove this pool later.
#if 0
...
// 6280 Hosted dongle: ECM feature
...
#define FLC2_NPDU_UL_POOL_SIZE              \
     (FLC2_NPDU_UL_CHUNK_SIZE * FLC2_NPDU_UL_CHUNKS + FLC2_NPDU_UL_ECM_BUF)

#define FLC2_NPDU_DL_POOL_SIZE              \
     (FLC2_NPDU_DL_CHUNK_SIZE * FLC2_NPDU_DL_CHUNKS * FLC2_MAX_NPDU_POOLS_NUM)
...
#define FLC2_PSPDU_POOL_SIZE(n)             (FLC2_MB_3_CHUNK_SIZE * (n))
...
// Every pool has its private memory. Growed memory is shared among all pools.
#define FLC2_MM_BLOCK_10_REAL_GROW_SIZE     \
    FLC2_MAX(FLC2_PSPDU_UNACK_UL_GROW_SIZE, FLC2_NPDU_UL_MAX_GROW)
...
/*****************************************************************************/
// C2K FLC2 POOL
#define FLC2_C2K_FWD_CHUNK_SIZE             (FLC2_MEM_SIZE_ALIGN_32(640 + 32 + 16 + 8))
#define FLC2_C2K_REV_CHUNK_SIZE             (FLC2_MEM_SIZE_ALIGN_32(252 + 32 + 16 + 8))
#define FLC2_C2K_SIG_CHUNK_SIZE             (FLC2_MEM_SIZE_ALIGN_32(100 + 32 + 16 + 8))

#define FLC2_C2K_FWD_NUM                    1200
#define FLC2_C2K_REV_NUM                    2000
#define FLC2_C2K_SIG_NUM                    200

#define FLC2_C2K_FWD_POOL_SIZE              (FLC2_C2K_FWD_CHUNK_SIZE * FLC2_C2K_FWD_NUM)     /* 825KB */
#define FLC2_C2K_REV_POOL_SIZE              (FLC2_C2K_REV_CHUNK_SIZE * FLC2_C2K_REV_NUM)     /* 625KB */
#define FLC2_C2K_SIG_POOL_SIZE              (FLC2_C2K_SIG_CHUNK_SIZE * FLC2_C2K_SIG_NUM)     /* 47KB */

#define FLC2_MM_BLOCK_C2K_SIG_SIZE          (FLC2_C2K_SIG_POOL_SIZE + \
                                             FLC2_MEM_ADM_CTRL_HEADER_LEN)
...
// HIFSMALL_UL, HIF_UL_02, INTERNAL_UL, NET_UL_SHARED
#define FLC2_FOR_LTE_ONLY_POOL_NUMBER   (4)
#else
#define FLC2_FOR_LTE_ONLY_POOL_NUMBER   (0)
#endif

#define FLC2_C2K_POOL_NUMBER            (3)
...
#define FLC2_ACT_POOL_ENTITY_TOTAL      (FLC2_APPDU_POOL_NUMBER + \
                                         ...
                                         FLC2_FOR_LTE_ONLY_POOL_NUMBER + \
                                         FLC2_C2K_POOL_NUMBER + \
