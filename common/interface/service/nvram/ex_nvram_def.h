 ...
 *============================================================================
 ****************************************************************************/
#ifndef __EX_NVRAM_DEF_H__
#define __EX_NVRAM_DEF_H__
...
typedef enum
{
        NVRAM_EF_SYS_EXCEPTION_LID_DUMMY            = NVRAM_LID_GRP_EX(0),
        NVRAM_EF_SYS_EXCEPTION_LID = NVRAM_EF_SYS_EXCEPTION_LID_DUMMY,
        NVRAM_EF_SYS_STATISTICS_LID,
		NVRAM_EF_L1_SYS_STATISTICS_LID,
        NVRAM_EF_EX_LAST_LID                        = NVRAM_LID_GRP_EX(63)
}nvram_lid_ex_enum;
