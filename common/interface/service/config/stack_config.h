...
#define KAL_MAX_NUM_NORMAL_HISRS  (40)    /* Maximum system HISR number */ /* 20 is normal HISR, 128 is LISR2HISR */
...
#if defined(__UNIFIED_ISR_LEVEL__)
typedef unsigned int hisr_max_num_check[(KAL_MAX_NUM_HISRS - 167) * (169 - KAL_MAX_NUM_HISRS)];
#else
typedef unsigned int hisr_max_num_check[(KAL_MAX_NUM_HISRS - (89 + 40)) * ((91 + 40) - KAL_MAX_NUM_HISRS)];
#endif
/************************************************************************/
