...
#endif
#ifdef __UMTS_R10__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_INTER_FREQ_DETECTED_SET_MEAS, "%Msim_interface_enum, Inter-frequency detected set measurement is configured.")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_UE_INFORMATION_REQUEST_2, "%Msim_interface_enum, RRC__UE_INFORMATION_REQUEST [MDT: %d, ANR: %d]")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_UE_INFORMATION_REQUEST_3, "%Msim_interface_enum, RRC__UE_INFORMATION_REQUEST [MDT: %d, ANR: %d, ConnFailure: %d]")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_LOGGING_MEASUREMENT_CONFIGURATION, "%Msim_interface_enum, RRC__LOGGING_MEASUREMENT_CONFIGURATION [MDT: %d, ANR: %d]")
#endif
#ifdef __LTE_RAT__
...
#endif
#ifdef __UMTS_R11__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_APBCR_IN_CELL_FACH, "%Msim_interface_enum, FMO for E-UTRA measurement in CELL_FACH is configured in cell(%d/%d).")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_EUTRA_RACH_REPORTING, "%Msim_interface_enum, E-UTRA RACH reporting is configured in cell(%d/%d).")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_EUTRA_MEASUREMENT_FOR_CELL_FACH, "%Msim_interface_enum, E-UTRA Measurement for CELL_FACH is configured.")

   TRC_MSG(EVENT_INFO_TRACE_FUNC_EAB, "%Msim_interface_enum, Extended Access Barring(EAB) is configured in SIB21 of cell(%d/%d)")
   //SIB5  R11 feature detection
   TRC_MSG(EVENT_INFO_TRACE_FUNC_R11_CELL_UPDATE_MSG_SUPPORT, "%Msim_interface_enum, R11 version Cell Update Message support in SIB5 of cell(%d/%d)")
   //SIB22 FE-FACH feature detection 
   TRC_MSG(EVENT_INFO_TRACE_FUNC_PRACH_PREAMBLE_ENHANCEDUPLINKLIST_TYPE, "%Msim_interface_enum, FE-FACH: PrachPreamble enhanced uplink type %d is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_CONCURRENT_TTI, "%Msim_interface_enum, FE-FACH: EDCH Concurrent TTI deployment is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_NODEB_TRIGGER_HS_DPCCH_TRANSMISSION, "%Msim_interface_enum, FE-FACH: NodeB triggered HS-DPCCH transmission is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_FALLBACK_R99_PRACH, "%Msim_interface_enum, FE-FACH: Fallback R99 PRACH is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_COMMON_EDCH_RESOURCE_INFO, "%Msim_interface_enum, FE-FACH: Common EDCH Resource Info is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_FEFACH_SECOND_DRXINFO, "%Msim_interface_enum, FE-FACH: FACH 2nd DRX is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_MFBI_IN_SIB_FOR_MEAS, "%Msim_interface_enum, MFBI for measurement is configured in SIB %s")
#endif /* __UMTS_R11__ */
#else
...
#endif
#ifdef __UMTS_R10__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_INTER_FREQ_DETECTED_SET_MEAS, "Inter-frequency detected set measurement is configured.")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_UE_INFORMATION_REQUEST_2, "RRC__UE_INFORMATION_REQUEST [MDT: %d, ANR: %d]")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_UE_INFORMATION_REQUEST_3, "RRC__UE_INFORMATION_REQUEST [MDT: %d, ANR: %d, ConnFailure: %d]")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_LOGGING_MEASUREMENT_CONFIGURATION, "RRC__LOGGING_MEASUREMENT_CONFIGURATION [MDT: %d, ANR: %d]")
#endif
#ifdef __LTE_RAT__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_APBCR_3G4_INTER_RAT_RESELECTION, "%Msim_interface_enum, [APBCR] 3G4 inter rat cell reselection in %MRRC_DB_RRC_StateType")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_3G4_CSG_AUTO_RESELECTION, "%Msim_interface_enum, [CSG] 3G4 CSG AUTO cell reselection in %MRRC_DB_RRC_StateType")
#endif
#ifdef __UMTS_R11__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_APBCR_IN_CELL_FACH, "FMO for E-UTRA measurement in CELL_FACH is configured in cell(%d/%d).")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_EUTRA_RACH_REPORTING, "E-UTRA RACH reporting is configured in cell(%d/%d).")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_EUTRA_MEASUREMENT_FOR_CELL_FACH, "E-UTRA Measurement for CELL_FACH is configured.")

   TRC_MSG(EVENT_INFO_TRACE_FUNC_EAB, "Extended Access Barring(EAB) is configured in SIB21 of cell(%d/%d)")
   //SIB5  R11 feature detection
   TRC_MSG(EVENT_INFO_TRACE_FUNC_R11_CELL_UPDATE_MSG_SUPPORT, "R11 version Cell Update Message support in SIB5 of cell(%d/%d)")
   //SIB22 FE-FACH feature detection 
   TRC_MSG(EVENT_INFO_TRACE_FUNC_PRACH_PREAMBLE_ENHANCEDUPLINKLIST_TYPE, "FE-FACH: PrachPreamble enhanced uplink type %d is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_CONCURRENT_TTI, "FE-FACH: EDCH Concurrent TTI deployment is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_NODEB_TRIGGER_HS_DPCCH_TRANSMISSION, "FE-FACH: NodeB triggered HS-DPCCH transmission is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_FALLBACK_R99_PRACH, "FE-FACH: Fallback R99 PRACH is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_COMMON_EDCH_RESOURCE_INFO, "FE-FACH: Common EDCH Resource Info is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_FEFACH_SECOND_DRXINFO, "FE-FACH: FACH 2nd DRX is configured in SIB22 of cell(%d/%d)")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_MFBI_IN_SIB_FOR_MEAS, "MFBI for measurement is configured in SIB %s")
#endif /* __UMTS_R11__ */
#endif //__GEMINI__ || __SGLTE__
