 ...
 *
 * 06 06 2017 iris.su
 * [MOLY00254378] [MT6293][EL1D] porting EL1D Warning Trace
 *
 * 01 10 2017 nicky.chou
 * [MOLY00223623] [EVENT_INFO] fix build warning for xL1SIM load
 * .
 *
...
#define MODEM_EL1D_WARNING_MESSAGE(expr, File, Line, ...) do {if(!(expr)) {} } while (0)
#else
...
#define MODEM_EL1D_WARNING_MESSAGE(expr, File, Line, ...) do{if (!(expr)) {\
                          assert_bypass_sys_trace((kal_char *)File,  Line, ##__VA_ARGS__, NULL);}\
                          ASSERT(0);}\
                          }while(0)  
...
#define MODEM_EL1D_WARNING_MESSAGE
#endif /*L1_SIM*/
